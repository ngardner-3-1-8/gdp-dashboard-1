...
if yes_i_have_pick_percents:
    ...
    if week_1_pick_percents:
        ...
        st.write('')
        az_week_1_pick_% = st.slider("Arizona Cardinals Estimated Week 1 Pick %:") / 100
        atl_week_1_pick_% = st.slider("Atlanta Falcons Estimated Week 1 Pick %:") / 100
        bal_week_1_pick_% = st.slider("Baltimore Ravens Estimated Week 1 Pick %:") / 100
        buf_week_1_pick_% = st.slider("Buffalo Bills Estimated Week 1 Pick %:") / 100
        car_week_1_pick_% = st.slider("Carolina Panthers Estimated Week 1 Pick %:") / 100
        chi_week_1_pick_% = st.slider("Chicago Bears Estimated Week 1 Pick %:") / 100
        cin_week_1_pick_% = st.slider("Cincinnati Bengals Estimated Week 1 Pick %:") / 100
        cle_week_1_pick_% = st.slider("Cleveland Browns Estimated Week 1 Pick %:") / 100
        dal_week_1_pick_% = st.slider("Dallas Cowboys Estimated Week 1 Pick %:") / 100
        den_week_1_pick_% = st.slider("Denver Broncos Estimated Week 1 Pick %:") / 100
        det_week_1_pick_% = st.slider("Detroit Lions Estimated Week 1 Pick %:") / 100
        gb_week_1_pick_% = st.slider("Green Bay Packers Estimated Week 1 Pick %:") / 100
        hou_week_1_pick_% = st.slider("Houston Texans Estimated Week 1 Pick %:") / 100
        ind_week_1_pick_% = st.slider("Indianapoils Colts Estimated Week 1 Pick %:") / 100
        jax_week_1_pick_% = st.slider("Jacksonville Jaguars Estimated Week 1 Pick %:") / 100
        kc_week_1_pick_% = st.slider("Kansas City Chiefs Estimated Week 1 Pick %:") / 100
        lv_week_1_pick_% = st.slider("Las Vegas Raiders Estimated Week 1 Pick %:") / 100
        lac_week_1_pick_% = st.slider("Los Angeles Chargers Estimated Week 1 Pick %:") / 100
        lar_week_1_pick_% = st.slider("Los Angeles Rams Estimated Week 1 Pick %:") / 100
        mia_week_1_pick_% = st.slider("Miami Dolphins Estimated Week 1 Pick %:") / 100
        min_week_1_pick_% = st.slider("Minnesota Vikings Estimated Week 1 Pick %:") / 100
        ne_week_1_pick_% = st.slider("New England Patriots Estimated Week 1 Pick %:") / 100
        no_week_1_pick_% = st.slider("New Orleans Saints Estimated Week 1 Pick %:") / 100
        nyg_week_1_pick_% = st.slider("New York Giants Estimated Week 1 Pick %:") / 100
        nyj_week_1_pick_% = st.slider("New York Jets Estimated Week 1 Pick %:") / 100
        phi_week_1_pick_% = st.slider("Philadelphia Eagles Estimated Week 1 Pick %:") / 100
        pit_week_1_pick_% = st.slider("Pittsburgh Steelers Estimated Week 1 Pick %:") / 100
        sf_week_1_pick_% = st.slider("San Francisco 49ers Estimated Week 1 Pick %:") / 100
        sea_week_1_pick_% = st.slider("Seattle Seahawks Estimated Week 1 Pick %:") / 100
        tb_week_1_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 1 Pick %:") / 100
        ten_week_1_pick_% = st.slider("Tennessee Titans Estimated Week 1 Pick %:") / 100
        was_week_1_pick_% = st.slider("Washington Commanders Estimated Week 1 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_2_pick_percents:
        ...
        st.write('')
        az_week_2_pick_% = st.slider("Arizona Cardinals Estimated Week 2 Pick %:") / 100
        atl_week_2_pick_% = st.slider("Atlanta Falcons Estimated Week 2 Pick %:") / 100
        bal_week_2_pick_% = st.slider("Baltimore Ravens Estimated Week 2 Pick %:") / 100
        buf_week_2_pick_% = st.slider("Buffalo Bills Estimated Week 2 Pick %:") / 100
        car_week_2_pick_% = st.slider("Carolina Panthers Estimated Week 2 Pick %:") / 100
        chi_week_2_pick_% = st.slider("Chicago Bears Estimated Week 2 Pick %:") / 100
        cin_week_2_pick_% = st.slider("Cincinnati Bengals Estimated Week 2 Pick %:") / 100
        cle_week_2_pick_% = st.slider("Cleveland Browns Estimated Week 2 Pick %:") / 100
        dal_week_2_pick_% = st.slider("Dallas Cowboys Estimated Week 2 Pick %:") / 100
        den_week_2_pick_% = st.slider("Denver Broncos Estimated Week 2 Pick %:") / 100
        det_week_2_pick_% = st.slider("Detroit Lions Estimated Week 2 Pick %:") / 100
        gb_week_2_pick_% = st.slider("Green Bay Packers Estimated Week 2 Pick %:") / 100
        hou_week_2_pick_% = st.slider("Houston Texans Estimated Week 2 Pick %:") / 100
        ind_week_2_pick_% = st.slider("Indianapoils Colts Estimated Week 2 Pick %:") / 100
        jax_week_2_pick_% = st.slider("Jacksonville Jaguars Estimated Week 2 Pick %:") / 100
        kc_week_2_pick_% = st.slider("Kansas City Chiefs Estimated Week 2 Pick %:") / 100
        lv_week_2_pick_% = st.slider("Las Vegas Raiders Estimated Week 2 Pick %:") / 100
        lac_week_2_pick_% = st.slider("Los Angeles Chargers Estimated Week 2 Pick %:") / 100
        lar_week_2_pick_% = st.slider("Los Angeles Rams Estimated Week 2 Pick %:") / 100
        mia_week_2_pick_% = st.slider("Miami Dolphins Estimated Week 2 Pick %:") / 100
        min_week_2_pick_% = st.slider("Minnesota Vikings Estimated Week 2 Pick %:") / 100
        ne_week_2_pick_% = st.slider("New England Patriots Estimated Week 2 Pick %:") / 100
        no_week_2_pick_% = st.slider("New Orleans Saints Estimated Week 2 Pick %:") / 100
        nyg_week_2_pick_% = st.slider("New York Giants Estimated Week 2 Pick %:") / 100
        nyj_week_2_pick_% = st.slider("New York Jets Estimated Week 2 Pick %:") / 100
        phi_week_2_pick_% = st.slider("Philadelphia Eagles Estimated Week 2 Pick %:") / 100
        pit_week_2_pick_% = st.slider("Pittsburgh Steelers Estimated Week 2 Pick %:") / 100
        sf_week_2_pick_% = st.slider("San Francisco 49ers Estimated Week 2 Pick %:") / 100
        sea_week_2_pick_% = st.slider("Seattle Seahawks Estimated Week 2 Pick %:") / 100
        tb_week_2_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 2 Pick %:") / 100
        ten_week_2_pick_% = st.slider("Tennessee Titans Estimated Week 2 Pick %:") / 100
        was_week_2_pick_% = st.slider("Washington Commanders Estimated Week 2 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_3_pick_percents:
        ...
        st.write('')
        az_week_3_pick_% = st.slider("Arizona Cardinals Estimated Week 3 Pick %:") / 100
        atl_week_3_pick_% = st.slider("Atlanta Falcons Estimated Week 3 Pick %:") / 100
        bal_week_3_pick_% = st.slider("Baltimore Ravens Estimated Week 3 Pick %:") / 100
        buf_week_3_pick_% = st.slider("Buffalo Bills Estimated Week 3 Pick %:") / 100
        car_week_3_pick_% = st.slider("Carolina Panthers Estimated Week 3 Pick %:") / 100
        chi_week_3_pick_% = st.slider("Chicago Bears Estimated Week 3 Pick %:") / 100
        cin_week_3_pick_% = st.slider("Cincinnati Bengals Estimated Week 3 Pick %:") / 100
        cle_week_3_pick_% = st.slider("Cleveland Browns Estimated Week 3 Pick %:") / 100
        dal_week_3_pick_% = st.slider("Dallas Cowboys Estimated Week 3 Pick %:") / 100
        den_week_3_pick_% = st.slider("Denver Broncos Estimated Week 3 Pick %:") / 100
        det_week_3_pick_% = st.slider("Detroit Lions Estimated Week 3 Pick %:") / 100
        gb_week_3_pick_% = st.slider("Green Bay Packers Estimated Week 3 Pick %:") / 100
        hou_week_3_pick_% = st.slider("Houston Texans Estimated Week 3 Pick %:") / 100
        ind_week_3_pick_% = st.slider("Indianapoils Colts Estimated Week 3 Pick %:") / 100
        jax_week_3_pick_% = st.slider("Jacksonville Jaguars Estimated Week 3 Pick %:") / 100
        kc_week_3_pick_% = st.slider("Kansas City Chiefs Estimated Week 3 Pick %:") / 100
        lv_week_3_pick_% = st.slider("Las Vegas Raiders Estimated Week 3 Pick %:") / 100
        lac_week_3_pick_% = st.slider("Los Angeles Chargers Estimated Week 3 Pick %:") / 100
        lar_week_3_pick_% = st.slider("Los Angeles Rams Estimated Week 3 Pick %:") / 100
        mia_week_3_pick_% = st.slider("Miami Dolphins Estimated Week 3 Pick %:") / 100
        min_week_3_pick_% = st.slider("Minnesota Vikings Estimated Week 3 Pick %:") / 100
        ne_week_3_pick_% = st.slider("New England Patriots Estimated Week 3 Pick %:") / 100
        no_week_3_pick_% = st.slider("New Orleans Saints Estimated Week 3 Pick %:") / 100
        nyg_week_3_pick_% = st.slider("New York Giants Estimated Week 3 Pick %:") / 100
        nyj_week_3_pick_% = st.slider("New York Jets Estimated Week 3 Pick %:") / 100
        phi_week_3_pick_% = st.slider("Philadelphia Eagles Estimated Week 3 Pick %:") / 100
        pit_week_3_pick_% = st.slider("Pittsburgh Steelers Estimated Week 3 Pick %:") / 100
        sf_week_3_pick_% = st.slider("San Francisco 49ers Estimated Week 3 Pick %:") / 100
        sea_week_3_pick_% = st.slider("Seattle Seahawks Estimated Week 3 Pick %:") / 100
        tb_week_3_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 3 Pick %:") / 100
        ten_week_3_pick_% = st.slider("Tennessee Titans Estimated Week 3 Pick %:") / 100
        was_week_3_pick_% = st.slider("Washington Commanders Estimated Week 3 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_4_pick_percents:
        ...
        st.write('')
        az_week_4_pick_% = st.slider("Arizona Cardinals Estimated Week 4 Pick %:") / 100
        atl_week_4_pick_% = st.slider("Atlanta Falcons Estimated Week 4 Pick %:") / 100
        bal_week_4_pick_% = st.slider("Baltimore Ravens Estimated Week 4 Pick %:") / 100
        buf_week_4_pick_% = st.slider("Buffalo Bills Estimated Week 4 Pick %:") / 100
        car_week_4_pick_% = st.slider("Carolina Panthers Estimated Week 4 Pick %:") / 100
        chi_week_4_pick_% = st.slider("Chicago Bears Estimated Week 4 Pick %:") / 100
        cin_week_4_pick_% = st.slider("Cincinnati Bengals Estimated Week 4 Pick %:") / 100
        cle_week_4_pick_% = st.slider("Cleveland Browns Estimated Week 4 Pick %:") / 100
        dal_week_4_pick_% = st.slider("Dallas Cowboys Estimated Week 4 Pick %:") / 100
        den_week_4_pick_% = st.slider("Denver Broncos Estimated Week 4 Pick %:") / 100
        det_week_4_pick_% = st.slider("Detroit Lions Estimated Week 4 Pick %:") / 100
        gb_week_4_pick_% = st.slider("Green Bay Packers Estimated Week 4 Pick %:") / 100
        hou_week_4_pick_% = st.slider("Houston Texans Estimated Week 4 Pick %:") / 100
        ind_week_4_pick_% = st.slider("Indianapoils Colts Estimated Week 4 Pick %:") / 100
        jax_week_4_pick_% = st.slider("Jacksonville Jaguars Estimated Week 4 Pick %:") / 100
        kc_week_4_pick_% = st.slider("Kansas City Chiefs Estimated Week 4 Pick %:") / 100
        lv_week_4_pick_% = st.slider("Las Vegas Raiders Estimated Week 4 Pick %:") / 100
        lac_week_4_pick_% = st.slider("Los Angeles Chargers Estimated Week 4 Pick %:") / 100
        lar_week_4_pick_% = st.slider("Los Angeles Rams Estimated Week 4 Pick %:") / 100
        mia_week_4_pick_% = st.slider("Miami Dolphins Estimated Week 4 Pick %:") / 100
        min_week_4_pick_% = st.slider("Minnesota Vikings Estimated Week 4 Pick %:") / 100
        ne_week_4_pick_% = st.slider("New England Patriots Estimated Week 4 Pick %:") / 100
        no_week_4_pick_% = st.slider("New Orleans Saints Estimated Week 4 Pick %:") / 100
        nyg_week_4_pick_% = st.slider("New York Giants Estimated Week 4 Pick %:") / 100
        nyj_week_4_pick_% = st.slider("New York Jets Estimated Week 4 Pick %:") / 100
        phi_week_4_pick_% = st.slider("Philadelphia Eagles Estimated Week 4 Pick %:") / 100
        pit_week_4_pick_% = st.slider("Pittsburgh Steelers Estimated Week 4 Pick %:") / 100
        sf_week_4_pick_% = st.slider("San Francisco 49ers Estimated Week 4 Pick %:") / 100
        sea_week_4_pick_% = st.slider("Seattle Seahawks Estimated Week 4 Pick %:") / 100
        tb_week_4_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 4 Pick %:") / 100
        ten_week_4_pick_% = st.slider("Tennessee Titans Estimated Week 4 Pick %:") / 100
        was_week_4_pick_% = st.slider("Washington Commanders Estimated Week 4 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_5_pick_percents:
        ...
        st.write('')
        az_week_5_pick_% = st.slider("Arizona Cardinals Estimated Week 5 Pick %:") / 100
        atl_week_5_pick_% = st.slider("Atlanta Falcons Estimated Week 5 Pick %:") / 100
        bal_week_5_pick_% = st.slider("Baltimore Ravens Estimated Week 5 Pick %:") / 100
        buf_week_5_pick_% = st.slider("Buffalo Bills Estimated Week 5 Pick %:") / 100
        car_week_5_pick_% = st.slider("Carolina Panthers Estimated Week 5 Pick %:") / 100
        chi_week_5_pick_% = st.slider("Chicago Bears Estimated Week 5 Pick %:") / 100
        cin_week_5_pick_% = st.slider("Cincinnati Bengals Estimated Week 5 Pick %:") / 100
        cle_week_5_pick_% = st.slider("Cleveland Browns Estimated Week 5 Pick %:") / 100
        dal_week_5_pick_% = st.slider("Dallas Cowboys Estimated Week 5 Pick %:") / 100
        den_week_5_pick_% = st.slider("Denver Broncos Estimated Week 5 Pick %:") / 100
        det_week_5_pick_% = st.slider("Detroit Lions Estimated Week 5 Pick %:") / 100
        gb_week_5_pick_% = st.slider("Green Bay Packers Estimated Week 5 Pick %:") / 100
        hou_week_5_pick_% = st.slider("Houston Texans Estimated Week 5 Pick %:") / 100
        ind_week_5_pick_% = st.slider("Indianapoils Colts Estimated Week 5 Pick %:") / 100
        jax_week_5_pick_% = st.slider("Jacksonville Jaguars Estimated Week 5 Pick %:") / 100
        kc_week_5_pick_% = st.slider("Kansas City Chiefs Estimated Week 5 Pick %:") / 100
        lv_week_5_pick_% = st.slider("Las Vegas Raiders Estimated Week 5 Pick %:") / 100
        lac_week_5_pick_% = st.slider("Los Angeles Chargers Estimated Week 5 Pick %:") / 100
        lar_week_5_pick_% = st.slider("Los Angeles Rams Estimated Week 5 Pick %:") / 100
        mia_week_5_pick_% = st.slider("Miami Dolphins Estimated Week 5 Pick %:") / 100
        min_week_5_pick_% = st.slider("Minnesota Vikings Estimated Week 5 Pick %:") / 100
        ne_week_5_pick_% = st.slider("New England Patriots Estimated Week 5 Pick %:") / 100
        no_week_5_pick_% = st.slider("New Orleans Saints Estimated Week 5 Pick %:") / 100
        nyg_week_5_pick_% = st.slider("New York Giants Estimated Week 5 Pick %:") / 100
        nyj_week_5_pick_% = st.slider("New York Jets Estimated Week 5 Pick %:") / 100
        phi_week_5_pick_% = st.slider("Philadelphia Eagles Estimated Week 5 Pick %:") / 100
        pit_week_5_pick_% = st.slider("Pittsburgh Steelers Estimated Week 5 Pick %:") / 100
        sf_week_5_pick_% = st.slider("San Francisco 59ers Estimated Week 5 Pick %:") / 100
        sea_week_5_pick_% = st.slider("Seattle Seahawks Estimated Week 5 Pick %:") / 100
        tb_week_5_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 5 Pick %:") / 100
        ten_week_5_pick_% = st.slider("Tennessee Titans Estimated Week 5 Pick %:") / 100
        was_week_5_pick_% = st.slider("Washington Commanders Estimated Week 5 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_6_pick_percents:
        ...
        st.write('')
        az_week_6_pick_% = st.slider("Arizona Cardinals Estimated Week 6 Pick %:") / 100
        atl_week_6_pick_% = st.slider("Atlanta Falcons Estimated Week 6 Pick %:") / 100
        bal_week_6_pick_% = st.slider("Baltimore Ravens Estimated Week 6 Pick %:") / 100
        buf_week_6_pick_% = st.slider("Buffalo Bills Estimated Week 6 Pick %:") / 100
        car_week_6_pick_% = st.slider("Carolina Panthers Estimated Week 6 Pick %:") / 100
        chi_week_6_pick_% = st.slider("Chicago Bears Estimated Week 6 Pick %:") / 100
        cin_week_6_pick_% = st.slider("Cincinnati Bengals Estimated Week 6 Pick %:") / 100
        cle_week_6_pick_% = st.slider("Cleveland Browns Estimated Week 6 Pick %:") / 100
        dal_week_6_pick_% = st.slider("Dallas Cowboys Estimated Week 6 Pick %:") / 100
        den_week_6_pick_% = st.slider("Denver Broncos Estimated Week 6 Pick %:") / 100
        det_week_6_pick_% = st.slider("Detroit Lions Estimated Week 6 Pick %:") / 100
        gb_week_6_pick_% = st.slider("Green Bay Packers Estimated Week 6 Pick %:") / 100
        hou_week_6_pick_% = st.slider("Houston Texans Estimated Week 6 Pick %:") / 100
        ind_week_6_pick_% = st.slider("Indianapoils Colts Estimated Week 6 Pick %:") / 100
        jax_week_6_pick_% = st.slider("Jacksonville Jaguars Estimated Week 6 Pick %:") / 100
        kc_week_6_pick_% = st.slider("Kansas City Chiefs Estimated Week 6 Pick %:") / 100
        lv_week_6_pick_% = st.slider("Las Vegas Raiders Estimated Week 6 Pick %:") / 100
        lac_week_6_pick_% = st.slider("Los Angeles Chargers Estimated Week 6 Pick %:") / 100
        lar_week_6_pick_% = st.slider("Los Angeles Rams Estimated Week 6 Pick %:") / 100
        mia_week_6_pick_% = st.slider("Miami Dolphins Estimated Week 6 Pick %:") / 100
        min_week_6_pick_% = st.slider("Minnesota Vikings Estimated Week 6 Pick %:") / 100
        ne_week_6_pick_% = st.slider("New England Patriots Estimated Week 6 Pick %:") / 100
        no_week_6_pick_% = st.slider("New Orleans Saints Estimated Week 6 Pick %:") / 100
        nyg_week_6_pick_% = st.slider("New York Giants Estimated Week 6 Pick %:") / 100
        nyj_week_6_pick_% = st.slider("New York Jets Estimated Week 6 Pick %:") / 100
        phi_week_6_pick_% = st.slider("Philadelphia Eagles Estimated Week 6 Pick %:") / 100
        pit_week_6_pick_% = st.slider("Pittsburgh Steelers Estimated Week 6 Pick %:") / 100
        sf_week_6_pick_% = st.slider("San Francisco 69ers Estimated Week 6 Pick %:") / 100
        sea_week_6_pick_% = st.slider("Seattle Seahawks Estimated Week 6 Pick %:") / 100
        tb_week_6_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 6 Pick %:") / 100
        ten_week_6_pick_% = st.slider("Tennessee Titans Estimated Week 6 Pick %:") / 100
        was_week_6_pick_% = st.slider("Washington Commanders Estimated Week 6 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_7_pick_percents:
        ...
        st.write('')
        az_week_7_pick_% = st.slider("Arizona Cardinals Estimated Week 7 Pick %:") / 100
        atl_week_7_pick_% = st.slider("Atlanta Falcons Estimated Week 7 Pick %:") / 100
        bal_week_7_pick_% = st.slider("Baltimore Ravens Estimated Week 7 Pick %:") / 100
        buf_week_7_pick_% = st.slider("Buffalo Bills Estimated Week 7 Pick %:") / 100
        car_week_7_pick_% = st.slider("Carolina Panthers Estimated Week 7 Pick %:") / 100
        chi_week_7_pick_% = st.slider("Chicago Bears Estimated Week 7 Pick %:") / 100
        cin_week_7_pick_% = st.slider("Cincinnati Bengals Estimated Week 7 Pick %:") / 100
        cle_week_7_pick_% = st.slider("Cleveland Browns Estimated Week 7 Pick %:") / 100
        dal_week_7_pick_% = st.slider("Dallas Cowboys Estimated Week 7 Pick %:") / 100
        den_week_7_pick_% = st.slider("Denver Broncos Estimated Week 7 Pick %:") / 100
        det_week_7_pick_% = st.slider("Detroit Lions Estimated Week 7 Pick %:") / 100
        gb_week_7_pick_% = st.slider("Green Bay Packers Estimated Week 7 Pick %:") / 100
        hou_week_7_pick_% = st.slider("Houston Texans Estimated Week 7 Pick %:") / 100
        ind_week_7_pick_% = st.slider("Indianapoils Colts Estimated Week 7 Pick %:") / 100
        jax_week_7_pick_% = st.slider("Jacksonville Jaguars Estimated Week 7 Pick %:") / 100
        kc_week_7_pick_% = st.slider("Kansas City Chiefs Estimated Week 7 Pick %:") / 100
        lv_week_7_pick_% = st.slider("Las Vegas Raiders Estimated Week 7 Pick %:") / 100
        lac_week_7_pick_% = st.slider("Los Angeles Chargers Estimated Week 7 Pick %:") / 100
        lar_week_7_pick_% = st.slider("Los Angeles Rams Estimated Week 7 Pick %:") / 100
        mia_week_7_pick_% = st.slider("Miami Dolphins Estimated Week 7 Pick %:") / 100
        min_week_7_pick_% = st.slider("Minnesota Vikings Estimated Week 7 Pick %:") / 100
        ne_week_7_pick_% = st.slider("New England Patriots Estimated Week 7 Pick %:") / 100
        no_week_7_pick_% = st.slider("New Orleans Saints Estimated Week 7 Pick %:") / 100
        nyg_week_7_pick_% = st.slider("New York Giants Estimated Week 7 Pick %:") / 100
        nyj_week_7_pick_% = st.slider("New York Jets Estimated Week 7 Pick %:") / 100
        phi_week_7_pick_% = st.slider("Philadelphia Eagles Estimated Week 7 Pick %:") / 100
        pit_week_7_pick_% = st.slider("Pittsburgh Steelers Estimated Week 7 Pick %:") / 100
        sf_week_7_pick_% = st.slider("San Francisco 79ers Estimated Week 7 Pick %:") / 100
        sea_week_7_pick_% = st.slider("Seattle Seahawks Estimated Week 7 Pick %:") / 100
        tb_week_7_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 7 Pick %:") / 100
        ten_week_7_pick_% = st.slider("Tennessee Titans Estimated Week 7 Pick %:") / 100
        was_week_7_pick_% = st.slider("Washington Commanders Estimated Week 7 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_8_pick_percents:
        ...
        st.write('')
        az_week_8_pick_% = st.slider("Arizona Cardinals Estimated Week 8 Pick %:") / 100
        atl_week_8_pick_% = st.slider("Atlanta Falcons Estimated Week 8 Pick %:") / 100
        bal_week_8_pick_% = st.slider("Baltimore Ravens Estimated Week 8 Pick %:") / 100
        buf_week_8_pick_% = st.slider("Buffalo Bills Estimated Week 8 Pick %:") / 100
        car_week_8_pick_% = st.slider("Carolina Panthers Estimated Week 8 Pick %:") / 100
        chi_week_8_pick_% = st.slider("Chicago Bears Estimated Week 8 Pick %:") / 100
        cin_week_8_pick_% = st.slider("Cincinnati Bengals Estimated Week 8 Pick %:") / 100
        cle_week_8_pick_% = st.slider("Cleveland Browns Estimated Week 8 Pick %:") / 100
        dal_week_8_pick_% = st.slider("Dallas Cowboys Estimated Week 8 Pick %:") / 100
        den_week_8_pick_% = st.slider("Denver Broncos Estimated Week 8 Pick %:") / 100
        det_week_8_pick_% = st.slider("Detroit Lions Estimated Week 8 Pick %:") / 100
        gb_week_8_pick_% = st.slider("Green Bay Packers Estimated Week 8 Pick %:") / 100
        hou_week_8_pick_% = st.slider("Houston Texans Estimated Week 8 Pick %:") / 100
        ind_week_8_pick_% = st.slider("Indianapoils Colts Estimated Week 8 Pick %:") / 100
        jax_week_8_pick_% = st.slider("Jacksonville Jaguars Estimated Week 8 Pick %:") / 100
        kc_week_8_pick_% = st.slider("Kansas City Chiefs Estimated Week 8 Pick %:") / 100
        lv_week_8_pick_% = st.slider("Las Vegas Raiders Estimated Week 8 Pick %:") / 100
        lac_week_8_pick_% = st.slider("Los Angeles Chargers Estimated Week 8 Pick %:") / 100
        lar_week_8_pick_% = st.slider("Los Angeles Rams Estimated Week 8 Pick %:") / 100
        mia_week_8_pick_% = st.slider("Miami Dolphins Estimated Week 8 Pick %:") / 100
        min_week_8_pick_% = st.slider("Minnesota Vikings Estimated Week 8 Pick %:") / 100
        ne_week_8_pick_% = st.slider("New England Patriots Estimated Week 8 Pick %:") / 100
        no_week_8_pick_% = st.slider("New Orleans Saints Estimated Week 8 Pick %:") / 100
        nyg_week_8_pick_% = st.slider("New York Giants Estimated Week 8 Pick %:") / 100
        nyj_week_8_pick_% = st.slider("New York Jets Estimated Week 8 Pick %:") / 100
        phi_week_8_pick_% = st.slider("Philadelphia Eagles Estimated Week 8 Pick %:") / 100
        pit_week_8_pick_% = st.slider("Pittsburgh Steelers Estimated Week 8 Pick %:") / 100
        sf_week_8_pick_% = st.slider("San Francisco 89ers Estimated Week 8 Pick %:") / 100
        sea_week_8_pick_% = st.slider("Seattle Seahawks Estimated Week 8 Pick %:") / 100
        tb_week_8_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 8 Pick %:") / 100
        ten_week_8_pick_% = st.slider("Tennessee Titans Estimated Week 8 Pick %:") / 100
        was_week_8_pick_% = st.slider("Washington Commanders Estimated Week 8 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_9_pick_percents:
        ...
        st.write('')
        az_week_9_pick_% = st.slider("Arizona Cardinals Estimated Week 9 Pick %:") / 100
        atl_week_9_pick_% = st.slider("Atlanta Falcons Estimated Week 9 Pick %:") / 100
        bal_week_9_pick_% = st.slider("Baltimore Ravens Estimated Week 9 Pick %:") / 100
        buf_week_9_pick_% = st.slider("Buffalo Bills Estimated Week 9 Pick %:") / 100
        car_week_9_pick_% = st.slider("Carolina Panthers Estimated Week 9 Pick %:") / 100
        chi_week_9_pick_% = st.slider("Chicago Bears Estimated Week 9 Pick %:") / 100
        cin_week_9_pick_% = st.slider("Cincinnati Bengals Estimated Week 9 Pick %:") / 100
        cle_week_9_pick_% = st.slider("Cleveland Browns Estimated Week 9 Pick %:") / 100
        dal_week_9_pick_% = st.slider("Dallas Cowboys Estimated Week 9 Pick %:") / 100
        den_week_9_pick_% = st.slider("Denver Broncos Estimated Week 9 Pick %:") / 100
        det_week_9_pick_% = st.slider("Detroit Lions Estimated Week 9 Pick %:") / 100
        gb_week_9_pick_% = st.slider("Green Bay Packers Estimated Week 9 Pick %:") / 100
        hou_week_9_pick_% = st.slider("Houston Texans Estimated Week 9 Pick %:") / 100
        ind_week_9_pick_% = st.slider("Indianapoils Colts Estimated Week 9 Pick %:") / 100
        jax_week_9_pick_% = st.slider("Jacksonville Jaguars Estimated Week 9 Pick %:") / 100
        kc_week_9_pick_% = st.slider("Kansas City Chiefs Estimated Week 9 Pick %:") / 100
        lv_week_9_pick_% = st.slider("Las Vegas Raiders Estimated Week 9 Pick %:") / 100
        lac_week_9_pick_% = st.slider("Los Angeles Chargers Estimated Week 9 Pick %:") / 100
        lar_week_9_pick_% = st.slider("Los Angeles Rams Estimated Week 9 Pick %:") / 100
        mia_week_9_pick_% = st.slider("Miami Dolphins Estimated Week 9 Pick %:") / 100
        min_week_9_pick_% = st.slider("Minnesota Vikings Estimated Week 9 Pick %:") / 100
        ne_week_9_pick_% = st.slider("New England Patriots Estimated Week 9 Pick %:") / 100
        no_week_9_pick_% = st.slider("New Orleans Saints Estimated Week 9 Pick %:") / 100
        nyg_week_9_pick_% = st.slider("New York Giants Estimated Week 9 Pick %:") / 100
        nyj_week_9_pick_% = st.slider("New York Jets Estimated Week 9 Pick %:") / 100
        phi_week_9_pick_% = st.slider("Philadelphia Eagles Estimated Week 9 Pick %:") / 100
        pit_week_9_pick_% = st.slider("Pittsburgh Steelers Estimated Week 9 Pick %:") / 100
        sf_week_9_pick_% = st.slider("San Francisco 99ers Estimated Week 9 Pick %:") / 100
        sea_week_9_pick_% = st.slider("Seattle Seahawks Estimated Week 9 Pick %:") / 100
        tb_week_9_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 9 Pick %:") / 100
        ten_week_9_pick_% = st.slider("Tennessee Titans Estimated Week 9 Pick %:") / 100
        was_week_9_pick_% = st.slider("Washington Commanders Estimated Week 9 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_10_pick_percents:
        ...
        st.write('')
        az_week_10_pick_% = st.slider("Arizona Cardinals Estimated Week 10 Pick %:") / 100
        atl_week_10_pick_% = st.slider("Atlanta Falcons Estimated Week 10 Pick %:") / 100
        bal_week_10_pick_% = st.slider("Baltimore Ravens Estimated Week 10 Pick %:") / 100
        buf_week_10_pick_% = st.slider("Buffalo Bills Estimated Week 10 Pick %:") / 100
        car_week_10_pick_% = st.slider("Carolina Panthers Estimated Week 10 Pick %:") / 100
        chi_week_10_pick_% = st.slider("Chicago Bears Estimated Week 10 Pick %:") / 100
        cin_week_10_pick_% = st.slider("Cincinnati Bengals Estimated Week 10 Pick %:") / 100
        cle_week_10_pick_% = st.slider("Cleveland Browns Estimated Week 10 Pick %:") / 100
        dal_week_10_pick_% = st.slider("Dallas Cowboys Estimated Week 10 Pick %:") / 100
        den_week_10_pick_% = st.slider("Denver Broncos Estimated Week 10 Pick %:") / 100
        det_week_10_pick_% = st.slider("Detroit Lions Estimated Week 10 Pick %:") / 100
        gb_week_10_pick_% = st.slider("Green Bay Packers Estimated Week 10 Pick %:") / 100
        hou_week_10_pick_% = st.slider("Houston Texans Estimated Week 10 Pick %:") / 100
        ind_week_10_pick_% = st.slider("Indianapoils Colts Estimated Week 10 Pick %:") / 100
        jax_week_10_pick_% = st.slider("Jacksonville Jaguars Estimated Week 10 Pick %:") / 100
        kc_week_10_pick_% = st.slider("Kansas City Chiefs Estimated Week 10 Pick %:") / 100
        lv_week_10_pick_% = st.slider("Las Vegas Raiders Estimated Week 10 Pick %:") / 100
        lac_week_10_pick_% = st.slider("Los Angeles Chargers Estimated Week 10 Pick %:") / 100
        lar_week_10_pick_% = st.slider("Los Angeles Rams Estimated Week 10 Pick %:") / 100
        mia_week_10_pick_% = st.slider("Miami Dolphins Estimated Week 10 Pick %:") / 100
        min_week_10_pick_% = st.slider("Minnesota Vikings Estimated Week 10 Pick %:") / 100
        ne_week_10_pick_% = st.slider("New England Patriots Estimated Week 10 Pick %:") / 100
        no_week_10_pick_% = st.slider("New Orleans Saints Estimated Week 10 Pick %:") / 100
        nyg_week_10_pick_% = st.slider("New York Giants Estimated Week 10 Pick %:") / 100
        nyj_week_10_pick_% = st.slider("New York Jets Estimated Week 10 Pick %:") / 100
        phi_week_10_pick_% = st.slider("Philadelphia Eagles Estimated Week 10 Pick %:") / 100
        pit_week_10_pick_% = st.slider("Pittsburgh Steelers Estimated Week 10 Pick %:") / 100
        sf_week_10_pick_% = st.slider("San Francisco 1010ers Estimated Week 10 Pick %:") / 100
        sea_week_10_pick_% = st.slider("Seattle Seahawks Estimated Week 10 Pick %:") / 100
        tb_week_10_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 10 Pick %:") / 100
        ten_week_10_pick_% = st.slider("Tennessee Titans Estimated Week 10 Pick %:") / 100
        was_week_10_pick_% = st.slider("Washington Commanders Estimated Week 10 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_11_pick_percents:
        ...
        st.write('')
        az_week_11_pick_% = st.slider("Arizona Cardinals Estimated Week 11 Pick %:") / 100
        atl_week_11_pick_% = st.slider("Atlanta Falcons Estimated Week 11 Pick %:") / 100
        bal_week_11_pick_% = st.slider("Baltimore Ravens Estimated Week 11 Pick %:") / 100
        buf_week_11_pick_% = st.slider("Buffalo Bills Estimated Week 11 Pick %:") / 100
        car_week_11_pick_% = st.slider("Carolina Panthers Estimated Week 11 Pick %:") / 100
        chi_week_11_pick_% = st.slider("Chicago Bears Estimated Week 11 Pick %:") / 100
        cin_week_11_pick_% = st.slider("Cincinnati Bengals Estimated Week 11 Pick %:") / 100
        cle_week_11_pick_% = st.slider("Cleveland Browns Estimated Week 11 Pick %:") / 100
        dal_week_11_pick_% = st.slider("Dallas Cowboys Estimated Week 11 Pick %:") / 100
        den_week_11_pick_% = st.slider("Denver Broncos Estimated Week 11 Pick %:") / 100
        det_week_11_pick_% = st.slider("Detroit Lions Estimated Week 11 Pick %:") / 100
        gb_week_11_pick_% = st.slider("Green Bay Packers Estimated Week 11 Pick %:") / 100
        hou_week_11_pick_% = st.slider("Houston Texans Estimated Week 11 Pick %:") / 100
        ind_week_11_pick_% = st.slider("Indianapoils Colts Estimated Week 11 Pick %:") / 100
        jax_week_11_pick_% = st.slider("Jacksonville Jaguars Estimated Week 11 Pick %:") / 100
        kc_week_11_pick_% = st.slider("Kansas City Chiefs Estimated Week 11 Pick %:") / 100
        lv_week_11_pick_% = st.slider("Las Vegas Raiders Estimated Week 11 Pick %:") / 100
        lac_week_11_pick_% = st.slider("Los Angeles Chargers Estimated Week 11 Pick %:") / 100
        lar_week_11_pick_% = st.slider("Los Angeles Rams Estimated Week 11 Pick %:") / 100
        mia_week_11_pick_% = st.slider("Miami Dolphins Estimated Week 11 Pick %:") / 100
        min_week_11_pick_% = st.slider("Minnesota Vikings Estimated Week 11 Pick %:") / 100
        ne_week_11_pick_% = st.slider("New England Patriots Estimated Week 11 Pick %:") / 100
        no_week_11_pick_% = st.slider("New Orleans Saints Estimated Week 11 Pick %:") / 100
        nyg_week_11_pick_% = st.slider("New York Giants Estimated Week 11 Pick %:") / 100
        nyj_week_11_pick_% = st.slider("New York Jets Estimated Week 11 Pick %:") / 100
        phi_week_11_pick_% = st.slider("Philadelphia Eagles Estimated Week 11 Pick %:") / 100
        pit_week_11_pick_% = st.slider("Pittsburgh Steelers Estimated Week 11 Pick %:") / 100
        sf_week_11_pick_% = st.slider("San Francisco 1111ers Estimated Week 11 Pick %:") / 100
        sea_week_11_pick_% = st.slider("Seattle Seahawks Estimated Week 11 Pick %:") / 100
        tb_week_11_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 11 Pick %:") / 100
        ten_week_11_pick_% = st.slider("Tennessee Titans Estimated Week 11 Pick %:") / 100
        was_week_11_pick_% = st.slider("Washington Commanders Estimated Week 11 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_12_pick_percents:
        ...
        st.write('')
        az_week_12_pick_% = st.slider("Arizona Cardinals Estimated Week 12 Pick %:") / 100
        atl_week_12_pick_% = st.slider("Atlanta Falcons Estimated Week 12 Pick %:") / 100
        bal_week_12_pick_% = st.slider("Baltimore Ravens Estimated Week 12 Pick %:") / 100
        buf_week_12_pick_% = st.slider("Buffalo Bills Estimated Week 12 Pick %:") / 100
        car_week_12_pick_% = st.slider("Carolina Panthers Estimated Week 12 Pick %:") / 100
        chi_week_12_pick_% = st.slider("Chicago Bears Estimated Week 12 Pick %:") / 100
        cin_week_12_pick_% = st.slider("Cincinnati Bengals Estimated Week 12 Pick %:") / 100
        cle_week_12_pick_% = st.slider("Cleveland Browns Estimated Week 12 Pick %:") / 100
        dal_week_12_pick_% = st.slider("Dallas Cowboys Estimated Week 12 Pick %:") / 100
        den_week_12_pick_% = st.slider("Denver Broncos Estimated Week 12 Pick %:") / 100
        det_week_12_pick_% = st.slider("Detroit Lions Estimated Week 12 Pick %:") / 100
        gb_week_12_pick_% = st.slider("Green Bay Packers Estimated Week 12 Pick %:") / 100
        hou_week_12_pick_% = st.slider("Houston Texans Estimated Week 12 Pick %:") / 100
        ind_week_12_pick_% = st.slider("Indianapoils Colts Estimated Week 12 Pick %:") / 100
        jax_week_12_pick_% = st.slider("Jacksonville Jaguars Estimated Week 12 Pick %:") / 100
        kc_week_12_pick_% = st.slider("Kansas City Chiefs Estimated Week 12 Pick %:") / 100
        lv_week_12_pick_% = st.slider("Las Vegas Raiders Estimated Week 12 Pick %:") / 100
        lac_week_12_pick_% = st.slider("Los Angeles Chargers Estimated Week 12 Pick %:") / 100
        lar_week_12_pick_% = st.slider("Los Angeles Rams Estimated Week 12 Pick %:") / 100
        mia_week_12_pick_% = st.slider("Miami Dolphins Estimated Week 12 Pick %:") / 100
        min_week_12_pick_% = st.slider("Minnesota Vikings Estimated Week 12 Pick %:") / 100
        ne_week_12_pick_% = st.slider("New England Patriots Estimated Week 12 Pick %:") / 100
        no_week_12_pick_% = st.slider("New Orleans Saints Estimated Week 12 Pick %:") / 100
        nyg_week_12_pick_% = st.slider("New York Giants Estimated Week 12 Pick %:") / 100
        nyj_week_12_pick_% = st.slider("New York Jets Estimated Week 12 Pick %:") / 100
        phi_week_12_pick_% = st.slider("Philadelphia Eagles Estimated Week 12 Pick %:") / 100
        pit_week_12_pick_% = st.slider("Pittsburgh Steelers Estimated Week 12 Pick %:") / 100
        sf_week_12_pick_% = st.slider("San Francisco 1212ers Estimated Week 12 Pick %:") / 100
        sea_week_12_pick_% = st.slider("Seattle Seahawks Estimated Week 12 Pick %:") / 100
        tb_week_12_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 12 Pick %:") / 100
        ten_week_12_pick_% = st.slider("Tennessee Titans Estimated Week 12 Pick %:") / 100
        was_week_12_pick_% = st.slider("Washington Commanders Estimated Week 12 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_13_pick_percents:
        ...
        st.write('')
        az_week_13_pick_% = st.slider("Arizona Cardinals Estimated Week 13 Pick %:") / 100
        atl_week_13_pick_% = st.slider("Atlanta Falcons Estimated Week 13 Pick %:") / 100
        bal_week_13_pick_% = st.slider("Baltimore Ravens Estimated Week 13 Pick %:") / 100
        buf_week_13_pick_% = st.slider("Buffalo Bills Estimated Week 13 Pick %:") / 100
        car_week_13_pick_% = st.slider("Carolina Panthers Estimated Week 13 Pick %:") / 100
        chi_week_13_pick_% = st.slider("Chicago Bears Estimated Week 13 Pick %:") / 100
        cin_week_13_pick_% = st.slider("Cincinnati Bengals Estimated Week 13 Pick %:") / 100
        cle_week_13_pick_% = st.slider("Cleveland Browns Estimated Week 13 Pick %:") / 100
        dal_week_13_pick_% = st.slider("Dallas Cowboys Estimated Week 13 Pick %:") / 100
        den_week_13_pick_% = st.slider("Denver Broncos Estimated Week 13 Pick %:") / 100
        det_week_13_pick_% = st.slider("Detroit Lions Estimated Week 13 Pick %:") / 100
        gb_week_13_pick_% = st.slider("Green Bay Packers Estimated Week 13 Pick %:") / 100
        hou_week_13_pick_% = st.slider("Houston Texans Estimated Week 13 Pick %:") / 100
        ind_week_13_pick_% = st.slider("Indianapoils Colts Estimated Week 13 Pick %:") / 100
        jax_week_13_pick_% = st.slider("Jacksonville Jaguars Estimated Week 13 Pick %:") / 100
        kc_week_13_pick_% = st.slider("Kansas City Chiefs Estimated Week 13 Pick %:") / 100
        lv_week_13_pick_% = st.slider("Las Vegas Raiders Estimated Week 13 Pick %:") / 100
        lac_week_13_pick_% = st.slider("Los Angeles Chargers Estimated Week 13 Pick %:") / 100
        lar_week_13_pick_% = st.slider("Los Angeles Rams Estimated Week 13 Pick %:") / 100
        mia_week_13_pick_% = st.slider("Miami Dolphins Estimated Week 13 Pick %:") / 100
        min_week_13_pick_% = st.slider("Minnesota Vikings Estimated Week 13 Pick %:") / 100
        ne_week_13_pick_% = st.slider("New England Patriots Estimated Week 13 Pick %:") / 100
        no_week_13_pick_% = st.slider("New Orleans Saints Estimated Week 13 Pick %:") / 100
        nyg_week_13_pick_% = st.slider("New York Giants Estimated Week 13 Pick %:") / 100
        nyj_week_13_pick_% = st.slider("New York Jets Estimated Week 13 Pick %:") / 100
        phi_week_13_pick_% = st.slider("Philadelphia Eagles Estimated Week 13 Pick %:") / 100
        pit_week_13_pick_% = st.slider("Pittsburgh Steelers Estimated Week 13 Pick %:") / 100
        sf_week_13_pick_% = st.slider("San Francisco 1313ers Estimated Week 13 Pick %:") / 100
        sea_week_13_pick_% = st.slider("Seattle Seahawks Estimated Week 13 Pick %:") / 100
        tb_week_13_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 13 Pick %:") / 100
        ten_week_13_pick_% = st.slider("Tennessee Titans Estimated Week 13 Pick %:") / 100
        was_week_13_pick_% = st.slider("Washington Commanders Estimated Week 13 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_14_pick_percents:
        ...
        st.write('')
        az_week_14_pick_% = st.slider("Arizona Cardinals Estimated Week 14 Pick %:") / 100
        atl_week_14_pick_% = st.slider("Atlanta Falcons Estimated Week 14 Pick %:") / 100
        bal_week_14_pick_% = st.slider("Baltimore Ravens Estimated Week 14 Pick %:") / 100
        buf_week_14_pick_% = st.slider("Buffalo Bills Estimated Week 14 Pick %:") / 100
        car_week_14_pick_% = st.slider("Carolina Panthers Estimated Week 14 Pick %:") / 100
        chi_week_14_pick_% = st.slider("Chicago Bears Estimated Week 14 Pick %:") / 100
        cin_week_14_pick_% = st.slider("Cincinnati Bengals Estimated Week 14 Pick %:") / 100
        cle_week_14_pick_% = st.slider("Cleveland Browns Estimated Week 14 Pick %:") / 100
        dal_week_14_pick_% = st.slider("Dallas Cowboys Estimated Week 14 Pick %:") / 100
        den_week_14_pick_% = st.slider("Denver Broncos Estimated Week 14 Pick %:") / 100
        det_week_14_pick_% = st.slider("Detroit Lions Estimated Week 14 Pick %:") / 100
        gb_week_14_pick_% = st.slider("Green Bay Packers Estimated Week 14 Pick %:") / 100
        hou_week_14_pick_% = st.slider("Houston Texans Estimated Week 14 Pick %:") / 100
        ind_week_14_pick_% = st.slider("Indianapoils Colts Estimated Week 14 Pick %:") / 100
        jax_week_14_pick_% = st.slider("Jacksonville Jaguars Estimated Week 14 Pick %:") / 100
        kc_week_14_pick_% = st.slider("Kansas City Chiefs Estimated Week 14 Pick %:") / 100
        lv_week_14_pick_% = st.slider("Las Vegas Raiders Estimated Week 14 Pick %:") / 100
        lac_week_14_pick_% = st.slider("Los Angeles Chargers Estimated Week 14 Pick %:") / 100
        lar_week_14_pick_% = st.slider("Los Angeles Rams Estimated Week 14 Pick %:") / 100
        mia_week_14_pick_% = st.slider("Miami Dolphins Estimated Week 14 Pick %:") / 100
        min_week_14_pick_% = st.slider("Minnesota Vikings Estimated Week 14 Pick %:") / 100
        ne_week_14_pick_% = st.slider("New England Patriots Estimated Week 14 Pick %:") / 100
        no_week_14_pick_% = st.slider("New Orleans Saints Estimated Week 14 Pick %:") / 100
        nyg_week_14_pick_% = st.slider("New York Giants Estimated Week 14 Pick %:") / 100
        nyj_week_14_pick_% = st.slider("New York Jets Estimated Week 14 Pick %:") / 100
        phi_week_14_pick_% = st.slider("Philadelphia Eagles Estimated Week 14 Pick %:") / 100
        pit_week_14_pick_% = st.slider("Pittsburgh Steelers Estimated Week 14 Pick %:") / 100
        sf_week_14_pick_% = st.slider("San Francisco 1414ers Estimated Week 14 Pick %:") / 100
        sea_week_14_pick_% = st.slider("Seattle Seahawks Estimated Week 14 Pick %:") / 100
        tb_week_14_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 14 Pick %:") / 100
        ten_week_14_pick_% = st.slider("Tennessee Titans Estimated Week 14 Pick %:") / 100
        was_week_14_pick_% = st.slider("Washington Commanders Estimated Week 14 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_15_pick_percents:
        ...
        st.write('')
        az_week_15_pick_% = st.slider("Arizona Cardinals Estimated Week 15 Pick %:") / 100
        atl_week_15_pick_% = st.slider("Atlanta Falcons Estimated Week 15 Pick %:") / 100
        bal_week_15_pick_% = st.slider("Baltimore Ravens Estimated Week 15 Pick %:") / 100
        buf_week_15_pick_% = st.slider("Buffalo Bills Estimated Week 15 Pick %:") / 100
        car_week_15_pick_% = st.slider("Carolina Panthers Estimated Week 15 Pick %:") / 100
        chi_week_15_pick_% = st.slider("Chicago Bears Estimated Week 15 Pick %:") / 100
        cin_week_15_pick_% = st.slider("Cincinnati Bengals Estimated Week 15 Pick %:") / 100
        cle_week_15_pick_% = st.slider("Cleveland Browns Estimated Week 15 Pick %:") / 100
        dal_week_15_pick_% = st.slider("Dallas Cowboys Estimated Week 15 Pick %:") / 100
        den_week_15_pick_% = st.slider("Denver Broncos Estimated Week 15 Pick %:") / 100
        det_week_15_pick_% = st.slider("Detroit Lions Estimated Week 15 Pick %:") / 100
        gb_week_15_pick_% = st.slider("Green Bay Packers Estimated Week 15 Pick %:") / 100
        hou_week_15_pick_% = st.slider("Houston Texans Estimated Week 15 Pick %:") / 100
        ind_week_15_pick_% = st.slider("Indianapoils Colts Estimated Week 15 Pick %:") / 100
        jax_week_15_pick_% = st.slider("Jacksonville Jaguars Estimated Week 15 Pick %:") / 100
        kc_week_15_pick_% = st.slider("Kansas City Chiefs Estimated Week 15 Pick %:") / 100
        lv_week_15_pick_% = st.slider("Las Vegas Raiders Estimated Week 15 Pick %:") / 100
        lac_week_15_pick_% = st.slider("Los Angeles Chargers Estimated Week 15 Pick %:") / 100
        lar_week_15_pick_% = st.slider("Los Angeles Rams Estimated Week 15 Pick %:") / 100
        mia_week_15_pick_% = st.slider("Miami Dolphins Estimated Week 15 Pick %:") / 100
        min_week_15_pick_% = st.slider("Minnesota Vikings Estimated Week 15 Pick %:") / 100
        ne_week_15_pick_% = st.slider("New England Patriots Estimated Week 15 Pick %:") / 100
        no_week_15_pick_% = st.slider("New Orleans Saints Estimated Week 15 Pick %:") / 100
        nyg_week_15_pick_% = st.slider("New York Giants Estimated Week 15 Pick %:") / 100
        nyj_week_15_pick_% = st.slider("New York Jets Estimated Week 15 Pick %:") / 100
        phi_week_15_pick_% = st.slider("Philadelphia Eagles Estimated Week 15 Pick %:") / 100
        pit_week_15_pick_% = st.slider("Pittsburgh Steelers Estimated Week 15 Pick %:") / 100
        sf_week_15_pick_% = st.slider("San Francisco 1515ers Estimated Week 15 Pick %:") / 100
        sea_week_15_pick_% = st.slider("Seattle Seahawks Estimated Week 15 Pick %:") / 100
        tb_week_15_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 15 Pick %:") / 100
        ten_week_15_pick_% = st.slider("Tennessee Titans Estimated Week 15 Pick %:") / 100
        was_week_15_pick_% = st.slider("Washington Commanders Estimated Week 15 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_16_pick_percents:
        ...
        st.write('')
        az_week_16_pick_% = st.slider("Arizona Cardinals Estimated Week 16 Pick %:") / 100
        atl_week_16_pick_% = st.slider("Atlanta Falcons Estimated Week 16 Pick %:") / 100
        bal_week_16_pick_% = st.slider("Baltimore Ravens Estimated Week 16 Pick %:") / 100
        buf_week_16_pick_% = st.slider("Buffalo Bills Estimated Week 16 Pick %:") / 100
        car_week_16_pick_% = st.slider("Carolina Panthers Estimated Week 16 Pick %:") / 100
        chi_week_16_pick_% = st.slider("Chicago Bears Estimated Week 16 Pick %:") / 100
        cin_week_16_pick_% = st.slider("Cincinnati Bengals Estimated Week 16 Pick %:") / 100
        cle_week_16_pick_% = st.slider("Cleveland Browns Estimated Week 16 Pick %:") / 100
        dal_week_16_pick_% = st.slider("Dallas Cowboys Estimated Week 16 Pick %:") / 100
        den_week_16_pick_% = st.slider("Denver Broncos Estimated Week 16 Pick %:") / 100
        det_week_16_pick_% = st.slider("Detroit Lions Estimated Week 16 Pick %:") / 100
        gb_week_16_pick_% = st.slider("Green Bay Packers Estimated Week 16 Pick %:") / 100
        hou_week_16_pick_% = st.slider("Houston Texans Estimated Week 16 Pick %:") / 100
        ind_week_16_pick_% = st.slider("Indianapoils Colts Estimated Week 16 Pick %:") / 100
        jax_week_16_pick_% = st.slider("Jacksonville Jaguars Estimated Week 16 Pick %:") / 100
        kc_week_16_pick_% = st.slider("Kansas City Chiefs Estimated Week 16 Pick %:") / 100
        lv_week_16_pick_% = st.slider("Las Vegas Raiders Estimated Week 16 Pick %:") / 100
        lac_week_16_pick_% = st.slider("Los Angeles Chargers Estimated Week 16 Pick %:") / 100
        lar_week_16_pick_% = st.slider("Los Angeles Rams Estimated Week 16 Pick %:") / 100
        mia_week_16_pick_% = st.slider("Miami Dolphins Estimated Week 16 Pick %:") / 100
        min_week_16_pick_% = st.slider("Minnesota Vikings Estimated Week 16 Pick %:") / 100
        ne_week_16_pick_% = st.slider("New England Patriots Estimated Week 16 Pick %:") / 100
        no_week_16_pick_% = st.slider("New Orleans Saints Estimated Week 16 Pick %:") / 100
        nyg_week_16_pick_% = st.slider("New York Giants Estimated Week 16 Pick %:") / 100
        nyj_week_16_pick_% = st.slider("New York Jets Estimated Week 16 Pick %:") / 100
        phi_week_16_pick_% = st.slider("Philadelphia Eagles Estimated Week 16 Pick %:") / 100
        pit_week_16_pick_% = st.slider("Pittsburgh Steelers Estimated Week 16 Pick %:") / 100
        sf_week_16_pick_% = st.slider("San Francisco 1616ers Estimated Week 16 Pick %:") / 100
        sea_week_16_pick_% = st.slider("Seattle Seahawks Estimated Week 16 Pick %:") / 100
        tb_week_16_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 16 Pick %:") / 100
        ten_week_16_pick_% = st.slider("Tennessee Titans Estimated Week 16 Pick %:") / 100
        was_week_16_pick_% = st.slider("Washington Commanders Estimated Week 16 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_17_pick_percents:
        ...
        st.write('')
        az_week_17_pick_% = st.slider("Arizona Cardinals Estimated Week 17 Pick %:") / 100
        atl_week_17_pick_% = st.slider("Atlanta Falcons Estimated Week 17 Pick %:") / 100
        bal_week_17_pick_% = st.slider("Baltimore Ravens Estimated Week 17 Pick %:") / 100
        buf_week_17_pick_% = st.slider("Buffalo Bills Estimated Week 17 Pick %:") / 100
        car_week_17_pick_% = st.slider("Carolina Panthers Estimated Week 17 Pick %:") / 100
        chi_week_17_pick_% = st.slider("Chicago Bears Estimated Week 17 Pick %:") / 100
        cin_week_17_pick_% = st.slider("Cincinnati Bengals Estimated Week 17 Pick %:") / 100
        cle_week_17_pick_% = st.slider("Cleveland Browns Estimated Week 17 Pick %:") / 100
        dal_week_17_pick_% = st.slider("Dallas Cowboys Estimated Week 17 Pick %:") / 100
        den_week_17_pick_% = st.slider("Denver Broncos Estimated Week 17 Pick %:") / 100
        det_week_17_pick_% = st.slider("Detroit Lions Estimated Week 17 Pick %:") / 100
        gb_week_17_pick_% = st.slider("Green Bay Packers Estimated Week 17 Pick %:") / 100
        hou_week_17_pick_% = st.slider("Houston Texans Estimated Week 17 Pick %:") / 100
        ind_week_17_pick_% = st.slider("Indianapoils Colts Estimated Week 17 Pick %:") / 100
        jax_week_17_pick_% = st.slider("Jacksonville Jaguars Estimated Week 17 Pick %:") / 100
        kc_week_17_pick_% = st.slider("Kansas City Chiefs Estimated Week 17 Pick %:") / 100
        lv_week_17_pick_% = st.slider("Las Vegas Raiders Estimated Week 17 Pick %:") / 100
        lac_week_17_pick_% = st.slider("Los Angeles Chargers Estimated Week 17 Pick %:") / 100
        lar_week_17_pick_% = st.slider("Los Angeles Rams Estimated Week 17 Pick %:") / 100
        mia_week_17_pick_% = st.slider("Miami Dolphins Estimated Week 17 Pick %:") / 100
        min_week_17_pick_% = st.slider("Minnesota Vikings Estimated Week 17 Pick %:") / 100
        ne_week_17_pick_% = st.slider("New England Patriots Estimated Week 17 Pick %:") / 100
        no_week_17_pick_% = st.slider("New Orleans Saints Estimated Week 17 Pick %:") / 100
        nyg_week_17_pick_% = st.slider("New York Giants Estimated Week 17 Pick %:") / 100
        nyj_week_17_pick_% = st.slider("New York Jets Estimated Week 17 Pick %:") / 100
        phi_week_17_pick_% = st.slider("Philadelphia Eagles Estimated Week 17 Pick %:") / 100
        pit_week_17_pick_% = st.slider("Pittsburgh Steelers Estimated Week 17 Pick %:") / 100
        sf_week_17_pick_% = st.slider("San Francisco 1717ers Estimated Week 17 Pick %:") / 100
        sea_week_17_pick_% = st.slider("Seattle Seahawks Estimated Week 17 Pick %:") / 100
        tb_week_17_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 17 Pick %:") / 100
        ten_week_17_pick_% = st.slider("Tennessee Titans Estimated Week 17 Pick %:") / 100
        was_week_17_pick_% = st.slider("Washington Commanders Estimated Week 17 Pick %:") / 100
    st.write('')
    st.write('')
    ...
    if week_18_pick_percents:
        ...
        st.write('')
        az_week_18_pick_% = st.slider("Arizona Cardinals Estimated Week 18 Pick %:") / 100
        atl_week_18_pick_% = st.slider("Atlanta Falcons Estimated Week 18 Pick %:") / 100
        bal_week_18_pick_% = st.slider("Baltimore Ravens Estimated Week 18 Pick %:") / 100
        buf_week_18_pick_% = st.slider("Buffalo Bills Estimated Week 18 Pick %:") / 100
        car_week_18_pick_% = st.slider("Carolina Panthers Estimated Week 18 Pick %:") / 100
        chi_week_18_pick_% = st.slider("Chicago Bears Estimated Week 18 Pick %:") / 100
        cin_week_18_pick_% = st.slider("Cincinnati Bengals Estimated Week 18 Pick %:") / 100
        cle_week_18_pick_% = st.slider("Cleveland Browns Estimated Week 18 Pick %:") / 100
        dal_week_18_pick_% = st.slider("Dallas Cowboys Estimated Week 18 Pick %:") / 100
        den_week_18_pick_% = st.slider("Denver Broncos Estimated Week 18 Pick %:") / 100
        det_week_18_pick_% = st.slider("Detroit Lions Estimated Week 18 Pick %:") / 100
        gb_week_18_pick_% = st.slider("Green Bay Packers Estimated Week 18 Pick %:") / 100
        hou_week_18_pick_% = st.slider("Houston Texans Estimated Week 18 Pick %:") / 100
        ind_week_18_pick_% = st.slider("Indianapoils Colts Estimated Week 18 Pick %:") / 100
        jax_week_18_pick_% = st.slider("Jacksonville Jaguars Estimated Week 18 Pick %:") / 100
        kc_week_18_pick_% = st.slider("Kansas City Chiefs Estimated Week 18 Pick %:") / 100
        lv_week_18_pick_% = st.slider("Las Vegas Raiders Estimated Week 18 Pick %:") / 100
        lac_week_18_pick_% = st.slider("Los Angeles Chargers Estimated Week 18 Pick %:") / 100
        lar_week_18_pick_% = st.slider("Los Angeles Rams Estimated Week 18 Pick %:") / 100
        mia_week_18_pick_% = st.slider("Miami Dolphins Estimated Week 18 Pick %:") / 100
        min_week_18_pick_% = st.slider("Minnesota Vikings Estimated Week 18 Pick %:") / 100
        ne_week_18_pick_% = st.slider("New England Patriots Estimated Week 18 Pick %:") / 100
        no_week_18_pick_% = st.slider("New Orleans Saints Estimated Week 18 Pick %:") / 100
        nyg_week_18_pick_% = st.slider("New York Giants Estimated Week 18 Pick %:") / 100
        nyj_week_18_pick_% = st.slider("New York Jets Estimated Week 18 Pick %:") / 100
        phi_week_18_pick_% = st.slider("Philadelphia Eagles Estimated Week 18 Pick %:") / 100
        pit_week_18_pick_% = st.slider("Pittsburgh Steelers Estimated Week 18 Pick %:") / 100
        sf_week_18_pick_% = st.slider("San Francisco 1818ers Estimated Week 18 Pick %:") / 100
        sea_week_18_pick_% = st.slider("Seattle Seahawks Estimated Week 18 Pick %:") / 100
        tb_week_18_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 18 Pick %:") / 100
        ten_week_18_pick_% = st.slider("Tennessee Titans Estimated Week 18 Pick %:") / 100
        was_week_18_pick_% = st.slider("Washington Commanders Estimated Week 18 Pick %:") / 100
    st.write('')
    st.write('')
    if selected_contest == 'Circa':
    ...
    if week_19_pick_percents:
        ...
        st.write('')
        az_week_19_pick_% = st.slider("Arizona Cardinals Estimated Week 19 Pick %:") / 100
        atl_week_19_pick_% = st.slider("Atlanta Falcons Estimated Week 19 Pick %:") / 100
        bal_week_19_pick_% = st.slider("Baltimore Ravens Estimated Week 19 Pick %:") / 100
        buf_week_19_pick_% = st.slider("Buffalo Bills Estimated Week 19 Pick %:") / 100
        car_week_19_pick_% = st.slider("Carolina Panthers Estimated Week 19 Pick %:") / 100
        chi_week_19_pick_% = st.slider("Chicago Bears Estimated Week 19 Pick %:") / 100
        cin_week_19_pick_% = st.slider("Cincinnati Bengals Estimated Week 19 Pick %:") / 100
        cle_week_19_pick_% = st.slider("Cleveland Browns Estimated Week 19 Pick %:") / 100
        dal_week_19_pick_% = st.slider("Dallas Cowboys Estimated Week 19 Pick %:") / 100
        den_week_19_pick_% = st.slider("Denver Broncos Estimated Week 19 Pick %:") / 100
        det_week_19_pick_% = st.slider("Detroit Lions Estimated Week 19 Pick %:") / 100
        gb_week_19_pick_% = st.slider("Green Bay Packers Estimated Week 19 Pick %:") / 100
        hou_week_19_pick_% = st.slider("Houston Texans Estimated Week 19 Pick %:") / 100
        ind_week_19_pick_% = st.slider("Indianapoils Colts Estimated Week 19 Pick %:") / 100
        jax_week_19_pick_% = st.slider("Jacksonville Jaguars Estimated Week 19 Pick %:") / 100
        kc_week_19_pick_% = st.slider("Kansas City Chiefs Estimated Week 19 Pick %:") / 100
        lv_week_19_pick_% = st.slider("Las Vegas Raiders Estimated Week 19 Pick %:") / 100
        lac_week_19_pick_% = st.slider("Los Angeles Chargers Estimated Week 19 Pick %:") / 100
        lar_week_19_pick_% = st.slider("Los Angeles Rams Estimated Week 19 Pick %:") / 100
        mia_week_19_pick_% = st.slider("Miami Dolphins Estimated Week 19 Pick %:") / 100
        min_week_19_pick_% = st.slider("Minnesota Vikings Estimated Week 19 Pick %:") / 100
        ne_week_19_pick_% = st.slider("New England Patriots Estimated Week 19 Pick %:") / 100
        no_week_19_pick_% = st.slider("New Orleans Saints Estimated Week 19 Pick %:") / 100
        nyg_week_19_pick_% = st.slider("New York Giants Estimated Week 19 Pick %:") / 100
        nyj_week_19_pick_% = st.slider("New York Jets Estimated Week 19 Pick %:") / 100
        phi_week_19_pick_% = st.slider("Philadelphia Eagles Estimated Week 19 Pick %:") / 100
        pit_week_19_pick_% = st.slider("Pittsburgh Steelers Estimated Week 19 Pick %:") / 100
        sf_week_19_pick_% = st.slider("San Francisco 1919ers Estimated Week 19 Pick %:") / 100
        sea_week_19_pick_% = st.slider("Seattle Seahawks Estimated Week 19 Pick %:") / 100
        tb_week_19_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 19 Pick %:") / 100
        ten_week_19_pick_% = st.slider("Tennessee Titans Estimated Week 19 Pick %:") / 100
        was_week_19_pick_% = st.slider("Washington Commanders Estimated Week 19 Pick %:") / 100
    st.write('')
    st.write('')
    if selected_contest == 'Circa':
    ...
    if week_20_pick_percents:
        ...
        st.write('')
        az_week_20_pick_% = st.slider("Arizona Cardinals Estimated Week 20 Pick %:") / 100
        atl_week_20_pick_% = st.slider("Atlanta Falcons Estimated Week 20 Pick %:") / 100
        bal_week_20_pick_% = st.slider("Baltimore Ravens Estimated Week 20 Pick %:") / 100
        buf_week_20_pick_% = st.slider("Buffalo Bills Estimated Week 20 Pick %:") / 100
        car_week_20_pick_% = st.slider("Carolina Panthers Estimated Week 20 Pick %:") / 100
        chi_week_20_pick_% = st.slider("Chicago Bears Estimated Week 20 Pick %:") / 100
        cin_week_20_pick_% = st.slider("Cincinnati Bengals Estimated Week 20 Pick %:") / 100
        cle_week_20_pick_% = st.slider("Cleveland Browns Estimated Week 20 Pick %:") / 100
        dal_week_20_pick_% = st.slider("Dallas Cowboys Estimated Week 20 Pick %:") / 100
        den_week_20_pick_% = st.slider("Denver Broncos Estimated Week 20 Pick %:") / 100
        det_week_20_pick_% = st.slider("Detroit Lions Estimated Week 20 Pick %:") / 100
        gb_week_20_pick_% = st.slider("Green Bay Packers Estimated Week 20 Pick %:") / 100
        hou_week_20_pick_% = st.slider("Houston Texans Estimated Week 20 Pick %:") / 100
        ind_week_20_pick_% = st.slider("Indianapoils Colts Estimated Week 20 Pick %:") / 100
        jax_week_20_pick_% = st.slider("Jacksonville Jaguars Estimated Week 20 Pick %:") / 100
        kc_week_20_pick_% = st.slider("Kansas City Chiefs Estimated Week 20 Pick %:") / 100
        lv_week_20_pick_% = st.slider("Las Vegas Raiders Estimated Week 20 Pick %:") / 100
        lac_week_20_pick_% = st.slider("Los Angeles Chargers Estimated Week 20 Pick %:") / 100
        lar_week_20_pick_% = st.slider("Los Angeles Rams Estimated Week 20 Pick %:") / 100
        mia_week_20_pick_% = st.slider("Miami Dolphins Estimated Week 20 Pick %:") / 100
        min_week_20_pick_% = st.slider("Minnesota Vikings Estimated Week 20 Pick %:") / 100
        ne_week_20_pick_% = st.slider("New England Patriots Estimated Week 20 Pick %:") / 100
        no_week_20_pick_% = st.slider("New Orleans Saints Estimated Week 20 Pick %:") / 100
        nyg_week_20_pick_% = st.slider("New York Giants Estimated Week 20 Pick %:") / 100
        nyj_week_20_pick_% = st.slider("New York Jets Estimated Week 20 Pick %:") / 100
        phi_week_20_pick_% = st.slider("Philadelphia Eagles Estimated Week 20 Pick %:") / 100
        pit_week_20_pick_% = st.slider("Pittsburgh Steelers Estimated Week 20 Pick %:") / 100
        sf_week_20_pick_% = st.slider("San Francisco 2020ers Estimated Week 20 Pick %:") / 100
        sea_week_20_pick_% = st.slider("Seattle Seahawks Estimated Week 20 Pick %:") / 100
        tb_week_20_pick_% = st.slider("Tampa Bay Buccaneers Estimated Week 20 Pick %:") / 100
        ten_week_20_pick_% = st.slider("Tennessee Titans Estimated Week 20 Pick %:") / 100
        was_week_20_pick_% = st.slider("Washington Commanders Estimated Week 20 Pick %:") / 100
