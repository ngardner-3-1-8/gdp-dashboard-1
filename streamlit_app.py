...
selected_content = st.selectbox('Choose Contest:', options = contest_options)
st.write('')
st.write('')
st.write('')
st.write('')
...
st.write('Avoid Away Teams on Short Rest')
st.write('Avoid Close Divisional Matchups')
st.write('Avoid 3 games in 10 days')
st.write('Avoid 4 games in 17 days')  
st.write('Avoid Away Teams in Close Games')
st.write('Avoid Rest Disadvantage')
st.write('Avoid Thursday Night Games')
st.write('Avoid Teams on Back to Back Away Games')
st.write('Avoid International Games')
st.write('Avoid Teams with Rest Disadvantage')
st.write('')
st.write('')
st.write('')
