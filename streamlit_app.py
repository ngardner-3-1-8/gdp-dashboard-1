...
def create_nfl_rankings():
    ...
    az_rank = st.multiselect("Arizona Cardinals Ranking:", options=team_rankings)
    atl_rank = st.multiselect("Atlanta Falcons Ranking:", options=team_rankings)
    bal_rank = st.multiselect("Baltimore Ravens Ranking:", options=team_rankings)
    buf_rank = st.multiselect("Buffalo Bills Ranking:", options=team_rankings)
    car_rank = st.multiselect("Carolina Panthers Ranking:", options=team_rankings)
    chi_rank = st.multiselect("Chicago Bears Ranking:", options=team_rankings)
    cin_rank = st.multiselect("Cincinatti Bengals Ranking:", options=team_rankings)
    cle_rank = st.multiselect("Cleveland Browns Ranking:", options=team_rankings)
    dal_rank = st.multiselect("Dallas Cowboys Ranking:", options=team_rankings)
    den_rank = st.multiselect("Denver Broncos Ranking:", options=team_rankings)
    det_rank = st.multiselect("Detroit Lions Ranking:", options=team_rankings)
    gb_rank = st.multiselect("Green Bay Packers Ranking:", options=team_rankings)
    hou_rank = st.multiselect("Houston Texans Ranking:", options=team_rankings)
    ind_rank = st.multiselect("Indianapoils Colts Ranking:", options=team_rankings)
    jax_rank = st.multiselect("Jacksonville Jaguars Ranking:", options=team_rankings)
    kc_rank = st.multiselect("Kansas City Chiefs Ranking:", options=team_rankings)
    lv_rank = st.multiselect("Las Vegas Raiders Ranking:", options=team_rankings)
    lac_rank = st.multiselect("Los Angeles Chargers Ranking:", options=team_rankings)
    lar_rank = st.multiselect("Los Angeles Rams Ranking:", options=team_rankings)
    mia_rank = st.multiselect("Miami Dolphins Ranking:", options=team_rankings)
    min_rank = st.multiselect("Minnesota Vikings Ranking:", options=team_rankings)
    ne_rank = st.multiselect("New England Patriots Ranking:", options=team_rankings)
    no_rank = st.multiselect("New Orleans Saints Ranking:", options=team_rankings)
    nyg_rank = st.multiselect("New York Giants Ranking:", options=team_rankings)
    nyj_rank = st.multiselect("New York Jets Ranking:", options=team_rankings)
    phi_rank = st.multiselect("Philadelphia Eagles Ranking:", options=team_rankings)
    pit_rank = st.multiselect("Pittsburgh Steelers Ranking:", options=team_rankings)
    sf_rank = st.multiselect("San Francisco 49ers Ranking:", options=team_rankings)
    sea_rank = st.multiselect("Seattle Seahawks Ranking:", options=team_rankings)
    tb_rank = st.multiselect("Tampa Bay Buccaneers Ranking:", options=team_rankings)
    ten_rank = st.multiselect("Tennessee Titans Ranking:", options=team_rankings)
    was_rank = st.multiselect("Washington Commanders Ranking:", options=team_rankings)
if __name__ == "__main__":
    create_nfl_rankings()
