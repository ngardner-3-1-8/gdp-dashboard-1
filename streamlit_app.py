...
def get_predicted_pick_percentages(pd):
    ...
    nfl_schedule_df['Home Expected Remaining Entry Percent vs Last Week'] = (1 * nfl_schedule_df['Home Team Fair Odds']) + ((1 - nfl_schedule_df['Home Pick %']) * nfl_schedule_df['Away Team Fair Odds'])
    nfl_schedule_df['Away Expected Remaining Entry Percent vs Last Week'] = (1 * nfl_schedule_df['Away Team Fair Odds']) + ((1 - nfl_schedule_df['Away Pick %']) * nfl_schedule_df['Home Team Fair Odds'])
    nfl_schedule_df['Weighted Average Remaining Entry Percent vs Last Week'] = (nfl_schedule_df['Home Expected Remaining Entry Percent vs Last Week'] * nfl_schedule_df['Home Team Fair Odds']) + (nfl_schedule_df['Away Expected Remaining Entry Percent vs Last Week'] * nfl_schedule_df['Away Team Fair Odds'])
    nfl_schedule_df['Expected Eliminated Entry Percent From Game'] = 1 - nfl_schedule_df['Weighted Average Remaining Entry Percent vs Last Week']
...
def calculate_ev():
    ...
    for week in tqdm(range(starting_week, ending_week), desc="Processing Weeks", leave=False): #########SET THE RANGE TO (1, 21) TO PROCESS THE WHOLE SEASON, or (2,3) to process ONLY WEEK . The rest you can figure out 
        week_df = nfl_schedule_pick_percentages_df[nfl_schedule_pick_percentages_df['Week_Num'] == week]
...
yes_i_have_pick percents = st.checkbox('Would you like to add your own estimated pick percentages, instead of using our estimated picks?')
if yes_i_have_pick percents:
    st.write('Select your own estimated pick percentages for each team. If you do not change the default value, then it will automatically select our own estimated picks. This tool will be especially useful later in the season'
    st.write('')
    st.write('')
    week_1_pick percents = st.checkbox('Add Week 1 Pick Percentages?')
    if week_1_pick_percents:
        st.write('')
        st.subheader('Week 1 Estimated Pick Percentages')
        st.write('')
        az_week_1_pick_% = st.selectbox("Arizona Cardinals Estimated Week 1 Pick %:", options=required_week_options)
        atl_week_1_pick_% = st.selectbox("Atlanta Falcons Estimated Week 1 Pick %:", options=required_week_options)
        bal_week_1_pick_% = st.selectbox("Baltimore Ravens Estimated Week 1 Pick %:", options=required_week_options)
        buf_week_1_pick_% = st.selectbox("Buffalo Bills Estimated Week 1 Pick %:", options=required_week_options)
        car_week_1_pick_% = st.selectbox("Carolina Panthers Estimated Week 1 Pick %:", options=required_week_options)
        chi_week_1_pick_% = st.selectbox("Chicago Bears Estimated Week 1 Pick %:", options=required_week_options)
        cin_week_1_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 1 Pick %:", options=required_week_options)
        cle_week_1_pick_% = st.selectbox("Cleveland Browns Estimated Week 1 Pick %:", options=required_week_options)
        dal_week_1_pick_% = st.selectbox("Dallas Cowboys Estimated Week 1 Pick %:", options=required_week_options)
        den_week_1_pick_% = st.selectbox("Denver Broncos Estimated Week 1 Pick %:", options=required_week_options)
        det_week_1_pick_% = st.selectbox("Detroit Lions Estimated Week 1 Pick %:", options=required_week_options)
        gb_week_1_pick_% = st.selectbox("Green Bay Packers Estimated Week 1 Pick %:", options=required_week_options)
        hou_week_1_pick_% = st.selectbox("Houston Texans Estimated Week 1 Pick %:", options=required_week_options)
        ind_week_1_pick_% = st.selectbox("Indianapoils Colts Estimated Week 1 Pick %:", options=required_week_options)
        jax_week_1_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 1 Pick %:", options=required_week_options)
        kc_week_1_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 1 Pick %:", options=required_week_options)
        lv_week_1_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 1 Pick %:", options=required_week_options)
        lac_week_1_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 1 Pick %:", options=required_week_options)
        lar_week_1_pick_% = st.selectbox("Los Angeles Rams Estimated Week 1 Pick %:", options=required_week_options)
        mia_week_1_pick_% = st.selectbox("Miami Dolphins Estimated Week 1 Pick %:", options=required_week_options)
        min_week_1_pick_% = st.selectbox("Minnesota Vikings Estimated Week 1 Pick %:", options=required_week_options)
        ne_week_1_pick_% = st.selectbox("New England Patriots Estimated Week 1 Pick %:", options=required_week_options)
        no_week_1_pick_% = st.selectbox("New Orleans Saints Estimated Week 1 Pick %:", options=required_week_options)
        nyg_week_1_pick_% = st.selectbox("New York Giants Estimated Week 1 Pick %:", options=required_week_options)
        nyj_week_1_pick_% = st.selectbox("New York Jets Estimated Week 1 Pick %:", options=required_week_options)
        phi_week_1_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 1 Pick %:", options=required_week_options)
        pit_week_1_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 1 Pick %:", options=required_week_options)
        sf_week_1_pick_% = st.selectbox("San Francisco 49ers Estimated Week 1 Pick %:", options=required_week_options)
        sea_week_1_pick_% = st.selectbox("Seattle Seahawks Estimated Week 1 Pick %:", options=required_week_options)
        tb_week_1_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 1 Pick %:", options=required_week_options)
        ten_week_1_pick_% = st.selectbox("Tennessee Titans Estimated Week 1 Pick %:", options=required_week_options)
        was_week_1_pick_% = st.selectbox("Washington Commanders Estimated Week 1 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_2_pick percents = st.checkbox('Add Week 2 Pick Percentages?')
    if week_2_pick_percents:
        st.write('')
        st.subheader('Week 2 Estimated Pick Percentages')
        st.write('')
        az_week_2_pick_% = st.selectbox("Arizona Cardinals Estimated Week 2 Pick %:", options=required_week_options)
        atl_week_2_pick_% = st.selectbox("Atlanta Falcons Estimated Week 2 Pick %:", options=required_week_options)
        bal_week_2_pick_% = st.selectbox("Baltimore Ravens Estimated Week 2 Pick %:", options=required_week_options)
        buf_week_2_pick_% = st.selectbox("Buffalo Bills Estimated Week 2 Pick %:", options=required_week_options)
        car_week_2_pick_% = st.selectbox("Carolina Panthers Estimated Week 2 Pick %:", options=required_week_options)
        chi_week_2_pick_% = st.selectbox("Chicago Bears Estimated Week 2 Pick %:", options=required_week_options)
        cin_week_2_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 2 Pick %:", options=required_week_options)
        cle_week_2_pick_% = st.selectbox("Cleveland Browns Estimated Week 2 Pick %:", options=required_week_options)
        dal_week_2_pick_% = st.selectbox("Dallas Cowboys Estimated Week 2 Pick %:", options=required_week_options)
        den_week_2_pick_% = st.selectbox("Denver Broncos Estimated Week 2 Pick %:", options=required_week_options)
        det_week_2_pick_% = st.selectbox("Detroit Lions Estimated Week 2 Pick %:", options=required_week_options)
        gb_week_2_pick_% = st.selectbox("Green Bay Packers Estimated Week 2 Pick %:", options=required_week_options)
        hou_week_2_pick_% = st.selectbox("Houston Texans Estimated Week 2 Pick %:", options=required_week_options)
        ind_week_2_pick_% = st.selectbox("Indianapoils Colts Estimated Week 2 Pick %:", options=required_week_options)
        jax_week_2_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 2 Pick %:", options=required_week_options)
        kc_week_2_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 2 Pick %:", options=required_week_options)
        lv_week_2_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 2 Pick %:", options=required_week_options)
        lac_week_2_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 2 Pick %:", options=required_week_options)
        lar_week_2_pick_% = st.selectbox("Los Angeles Rams Estimated Week 2 Pick %:", options=required_week_options)
        mia_week_2_pick_% = st.selectbox("Miami Dolphins Estimated Week 2 Pick %:", options=required_week_options)
        min_week_2_pick_% = st.selectbox("Minnesota Vikings Estimated Week 2 Pick %:", options=required_week_options)
        ne_week_2_pick_% = st.selectbox("New England Patriots Estimated Week 2 Pick %:", options=required_week_options)
        no_week_2_pick_% = st.selectbox("New Orleans Saints Estimated Week 2 Pick %:", options=required_week_options)
        nyg_week_2_pick_% = st.selectbox("New York Giants Estimated Week 2 Pick %:", options=required_week_options)
        nyj_week_2_pick_% = st.selectbox("New York Jets Estimated Week 2 Pick %:", options=required_week_options)
        phi_week_2_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 2 Pick %:", options=required_week_options)
        pit_week_2_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 2 Pick %:", options=required_week_options)
        sf_week_2_pick_% = st.selectbox("San Francisco 49ers Estimated Week 2 Pick %:", options=required_week_options)
        sea_week_2_pick_% = st.selectbox("Seattle Seahawks Estimated Week 2 Pick %:", options=required_week_options)
        tb_week_2_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 2 Pick %:", options=required_week_options)
        ten_week_2_pick_% = st.selectbox("Tennessee Titans Estimated Week 2 Pick %:", options=required_week_options)
        was_week_2_pick_% = st.selectbox("Washington Commanders Estimated Week 2 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_2_pick percents = st.checkbox('Add Week 2 Pick Percentages?')
    if week_2_pick_percents:
    ...
    st.write('')
    st.write('')
    week_4_pick percents = st.checkbox('Add Week 4 Pick Percentages?')
    if week_4_pick_percents:
        st.write('')
        st.subheader('Week 4 Estimated Pick Percentages')
        st.write('')
        az_week_4_pick_% = st.selectbox("Arizona Cardinals Estimated Week 4 Pick %:", options=required_week_options)
        atl_week_4_pick_% = st.selectbox("Atlanta Falcons Estimated Week 4 Pick %:", options=required_week_options)
        bal_week_4_pick_% = st.selectbox("Baltimore Ravens Estimated Week 4 Pick %:", options=required_week_options)
        buf_week_4_pick_% = st.selectbox("Buffalo Bills Estimated Week 4 Pick %:", options=required_week_options)
        car_week_4_pick_% = st.selectbox("Carolina Panthers Estimated Week 4 Pick %:", options=required_week_options)
        chi_week_4_pick_% = st.selectbox("Chicago Bears Estimated Week 4 Pick %:", options=required_week_options)
        cin_week_4_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 4 Pick %:", options=required_week_options)
        cle_week_4_pick_% = st.selectbox("Cleveland Browns Estimated Week 4 Pick %:", options=required_week_options)
        dal_week_4_pick_% = st.selectbox("Dallas Cowboys Estimated Week 4 Pick %:", options=required_week_options)
        den_week_4_pick_% = st.selectbox("Denver Broncos Estimated Week 4 Pick %:", options=required_week_options)
        det_week_4_pick_% = st.selectbox("Detroit Lions Estimated Week 4 Pick %:", options=required_week_options)
        gb_week_4_pick_% = st.selectbox("Green Bay Packers Estimated Week 4 Pick %:", options=required_week_options)
        hou_week_4_pick_% = st.selectbox("Houston Texans Estimated Week 4 Pick %:", options=required_week_options)
        ind_week_4_pick_% = st.selectbox("Indianapoils Colts Estimated Week 4 Pick %:", options=required_week_options)
        jax_week_4_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 4 Pick %:", options=required_week_options)
        kc_week_4_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 4 Pick %:", options=required_week_options)
        lv_week_4_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 4 Pick %:", options=required_week_options)
        lac_week_4_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 4 Pick %:", options=required_week_options)
        lar_week_4_pick_% = st.selectbox("Los Angeles Rams Estimated Week 4 Pick %:", options=required_week_options)
        mia_week_4_pick_% = st.selectbox("Miami Dolphins Estimated Week 4 Pick %:", options=required_week_options)
        min_week_4_pick_% = st.selectbox("Minnesota Vikings Estimated Week 4 Pick %:", options=required_week_options)
        ne_week_4_pick_% = st.selectbox("New England Patriots Estimated Week 4 Pick %:", options=required_week_options)
        no_week_4_pick_% = st.selectbox("New Orleans Saints Estimated Week 4 Pick %:", options=required_week_options)
        nyg_week_4_pick_% = st.selectbox("New York Giants Estimated Week 4 Pick %:", options=required_week_options)
        nyj_week_4_pick_% = st.selectbox("New York Jets Estimated Week 4 Pick %:", options=required_week_options)
        phi_week_4_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 4 Pick %:", options=required_week_options)
        pit_week_4_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 4 Pick %:", options=required_week_options)
        sf_week_4_pick_% = st.selectbox("San Francisco 49ers Estimated Week 4 Pick %:", options=required_week_options)
        sea_week_4_pick_% = st.selectbox("Seattle Seahawks Estimated Week 4 Pick %:", options=required_week_options)
        tb_week_4_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 4 Pick %:", options=required_week_options)
        ten_week_4_pick_% = st.selectbox("Tennessee Titans Estimated Week 4 Pick %:", options=required_week_options)
        was_week_4_pick_% = st.selectbox("Washington Commanders Estimated Week 4 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_5_pick percents = st.checkbox('Add Week 5 Pick Percentages?')
    if week_5_pick_percents:
        st.write('')
        st.subheader('Week 5 Estimated Pick Percentages')
        st.write('')
        az_week_5_pick_% = st.selectbox("Arizona Cardinals Estimated Week 5 Pick %:", options=required_week_options)
        atl_week_5_pick_% = st.selectbox("Atlanta Falcons Estimated Week 5 Pick %:", options=required_week_options)
        bal_week_5_pick_% = st.selectbox("Baltimore Ravens Estimated Week 5 Pick %:", options=required_week_options)
        buf_week_5_pick_% = st.selectbox("Buffalo Bills Estimated Week 5 Pick %:", options=required_week_options)
        car_week_5_pick_% = st.selectbox("Carolina Panthers Estimated Week 5 Pick %:", options=required_week_options)
        chi_week_5_pick_% = st.selectbox("Chicago Bears Estimated Week 5 Pick %:", options=required_week_options)
        cin_week_5_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 5 Pick %:", options=required_week_options)
        cle_week_5_pick_% = st.selectbox("Cleveland Browns Estimated Week 5 Pick %:", options=required_week_options)
        dal_week_5_pick_% = st.selectbox("Dallas Cowboys Estimated Week 5 Pick %:", options=required_week_options)
        den_week_5_pick_% = st.selectbox("Denver Broncos Estimated Week 5 Pick %:", options=required_week_options)
        det_week_5_pick_% = st.selectbox("Detroit Lions Estimated Week 5 Pick %:", options=required_week_options)
        gb_week_5_pick_% = st.selectbox("Green Bay Packers Estimated Week 5 Pick %:", options=required_week_options)
        hou_week_5_pick_% = st.selectbox("Houston Texans Estimated Week 5 Pick %:", options=required_week_options)
        ind_week_5_pick_% = st.selectbox("Indianapoils Colts Estimated Week 5 Pick %:", options=required_week_options)
        jax_week_5_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 5 Pick %:", options=required_week_options)
        kc_week_5_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 5 Pick %:", options=required_week_options)
        lv_week_5_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 5 Pick %:", options=required_week_options)
        lac_week_5_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 5 Pick %:", options=required_week_options)
        lar_week_5_pick_% = st.selectbox("Los Angeles Rams Estimated Week 5 Pick %:", options=required_week_options)
        mia_week_5_pick_% = st.selectbox("Miami Dolphins Estimated Week 5 Pick %:", options=required_week_options)
        min_week_5_pick_% = st.selectbox("Minnesota Vikings Estimated Week 5 Pick %:", options=required_week_options)
        ne_week_5_pick_% = st.selectbox("New England Patriots Estimated Week 5 Pick %:", options=required_week_options)
        no_week_5_pick_% = st.selectbox("New Orleans Saints Estimated Week 5 Pick %:", options=required_week_options)
        nyg_week_5_pick_% = st.selectbox("New York Giants Estimated Week 5 Pick %:", options=required_week_options)
        nyj_week_5_pick_% = st.selectbox("New York Jets Estimated Week 5 Pick %:", options=required_week_options)
        phi_week_5_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 5 Pick %:", options=required_week_options)
        pit_week_5_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 5 Pick %:", options=required_week_options)
        sf_week_5_pick_% = st.selectbox("San Francisco 59ers Estimated Week 5 Pick %:", options=required_week_options)
        sea_week_5_pick_% = st.selectbox("Seattle Seahawks Estimated Week 5 Pick %:", options=required_week_options)
        tb_week_5_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 5 Pick %:", options=required_week_options)
        ten_week_5_pick_% = st.selectbox("Tennessee Titans Estimated Week 5 Pick %:", options=required_week_options)
        was_week_5_pick_% = st.selectbox("Washington Commanders Estimated Week 5 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_6_pick percents = st.checkbox('Add Week 6 Pick Percentages?')
    if week_6_pick_percents:
        st.write('')
        st.subheader('Week 6 Estimated Pick Percentages')
        st.write('')
        az_week_6_pick_% = st.selectbox("Arizona Cardinals Estimated Week 6 Pick %:", options=required_week_options)
        atl_week_6_pick_% = st.selectbox("Atlanta Falcons Estimated Week 6 Pick %:", options=required_week_options)
        bal_week_6_pick_% = st.selectbox("Baltimore Ravens Estimated Week 6 Pick %:", options=required_week_options)
        buf_week_6_pick_% = st.selectbox("Buffalo Bills Estimated Week 6 Pick %:", options=required_week_options)
        car_week_6_pick_% = st.selectbox("Carolina Panthers Estimated Week 6 Pick %:", options=required_week_options)
        chi_week_6_pick_% = st.selectbox("Chicago Bears Estimated Week 6 Pick %:", options=required_week_options)
        cin_week_6_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 6 Pick %:", options=required_week_options)
        cle_week_6_pick_% = st.selectbox("Cleveland Browns Estimated Week 6 Pick %:", options=required_week_options)
        dal_week_6_pick_% = st.selectbox("Dallas Cowboys Estimated Week 6 Pick %:", options=required_week_options)
        den_week_6_pick_% = st.selectbox("Denver Broncos Estimated Week 6 Pick %:", options=required_week_options)
        det_week_6_pick_% = st.selectbox("Detroit Lions Estimated Week 6 Pick %:", options=required_week_options)
        gb_week_6_pick_% = st.selectbox("Green Bay Packers Estimated Week 6 Pick %:", options=required_week_options)
        hou_week_6_pick_% = st.selectbox("Houston Texans Estimated Week 6 Pick %:", options=required_week_options)
        ind_week_6_pick_% = st.selectbox("Indianapoils Colts Estimated Week 6 Pick %:", options=required_week_options)
        jax_week_6_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 6 Pick %:", options=required_week_options)
        kc_week_6_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 6 Pick %:", options=required_week_options)
        lv_week_6_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 6 Pick %:", options=required_week_options)
        lac_week_6_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 6 Pick %:", options=required_week_options)
        lar_week_6_pick_% = st.selectbox("Los Angeles Rams Estimated Week 6 Pick %:", options=required_week_options)
        mia_week_6_pick_% = st.selectbox("Miami Dolphins Estimated Week 6 Pick %:", options=required_week_options)
        min_week_6_pick_% = st.selectbox("Minnesota Vikings Estimated Week 6 Pick %:", options=required_week_options)
        ne_week_6_pick_% = st.selectbox("New England Patriots Estimated Week 6 Pick %:", options=required_week_options)
        no_week_6_pick_% = st.selectbox("New Orleans Saints Estimated Week 6 Pick %:", options=required_week_options)
        nyg_week_6_pick_% = st.selectbox("New York Giants Estimated Week 6 Pick %:", options=required_week_options)
        nyj_week_6_pick_% = st.selectbox("New York Jets Estimated Week 6 Pick %:", options=required_week_options)
        phi_week_6_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 6 Pick %:", options=required_week_options)
        pit_week_6_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 6 Pick %:", options=required_week_options)
        sf_week_6_pick_% = st.selectbox("San Francisco 69ers Estimated Week 6 Pick %:", options=required_week_options)
        sea_week_6_pick_% = st.selectbox("Seattle Seahawks Estimated Week 6 Pick %:", options=required_week_options)
        tb_week_6_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 6 Pick %:", options=required_week_options)
        ten_week_6_pick_% = st.selectbox("Tennessee Titans Estimated Week 6 Pick %:", options=required_week_options)
        was_week_6_pick_% = st.selectbox("Washington Commanders Estimated Week 6 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_7_pick percents = st.checkbox('Add Week 7 Pick Percentages?')
    if week_7_pick_percents:
        st.write('')
        st.subheader('Week 7 Estimated Pick Percentages')
        st.write('')
        az_week_7_pick_% = st.selectbox("Arizona Cardinals Estimated Week 7 Pick %:", options=required_week_options)
        atl_week_7_pick_% = st.selectbox("Atlanta Falcons Estimated Week 7 Pick %:", options=required_week_options)
        bal_week_7_pick_% = st.selectbox("Baltimore Ravens Estimated Week 7 Pick %:", options=required_week_options)
        buf_week_7_pick_% = st.selectbox("Buffalo Bills Estimated Week 7 Pick %:", options=required_week_options)
        car_week_7_pick_% = st.selectbox("Carolina Panthers Estimated Week 7 Pick %:", options=required_week_options)
        chi_week_7_pick_% = st.selectbox("Chicago Bears Estimated Week 7 Pick %:", options=required_week_options)
        cin_week_7_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 7 Pick %:", options=required_week_options)
        cle_week_7_pick_% = st.selectbox("Cleveland Browns Estimated Week 7 Pick %:", options=required_week_options)
        dal_week_7_pick_% = st.selectbox("Dallas Cowboys Estimated Week 7 Pick %:", options=required_week_options)
        den_week_7_pick_% = st.selectbox("Denver Broncos Estimated Week 7 Pick %:", options=required_week_options)
        det_week_7_pick_% = st.selectbox("Detroit Lions Estimated Week 7 Pick %:", options=required_week_options)
        gb_week_7_pick_% = st.selectbox("Green Bay Packers Estimated Week 7 Pick %:", options=required_week_options)
        hou_week_7_pick_% = st.selectbox("Houston Texans Estimated Week 7 Pick %:", options=required_week_options)
        ind_week_7_pick_% = st.selectbox("Indianapoils Colts Estimated Week 7 Pick %:", options=required_week_options)
        jax_week_7_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 7 Pick %:", options=required_week_options)
        kc_week_7_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 7 Pick %:", options=required_week_options)
        lv_week_7_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 7 Pick %:", options=required_week_options)
        lac_week_7_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 7 Pick %:", options=required_week_options)
        lar_week_7_pick_% = st.selectbox("Los Angeles Rams Estimated Week 7 Pick %:", options=required_week_options)
        mia_week_7_pick_% = st.selectbox("Miami Dolphins Estimated Week 7 Pick %:", options=required_week_options)
        min_week_7_pick_% = st.selectbox("Minnesota Vikings Estimated Week 7 Pick %:", options=required_week_options)
        ne_week_7_pick_% = st.selectbox("New England Patriots Estimated Week 7 Pick %:", options=required_week_options)
        no_week_7_pick_% = st.selectbox("New Orleans Saints Estimated Week 7 Pick %:", options=required_week_options)
        nyg_week_7_pick_% = st.selectbox("New York Giants Estimated Week 7 Pick %:", options=required_week_options)
        nyj_week_7_pick_% = st.selectbox("New York Jets Estimated Week 7 Pick %:", options=required_week_options)
        phi_week_7_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 7 Pick %:", options=required_week_options)
        pit_week_7_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 7 Pick %:", options=required_week_options)
        sf_week_7_pick_% = st.selectbox("San Francisco 79ers Estimated Week 7 Pick %:", options=required_week_options)
        sea_week_7_pick_% = st.selectbox("Seattle Seahawks Estimated Week 7 Pick %:", options=required_week_options)
        tb_week_7_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 7 Pick %:", options=required_week_options)
        ten_week_7_pick_% = st.selectbox("Tennessee Titans Estimated Week 7 Pick %:", options=required_week_options)
        was_week_7_pick_% = st.selectbox("Washington Commanders Estimated Week 7 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_8_pick percents = st.checkbox('Add Week 8 Pick Percentages?')
    if week_8_pick_percents:
        st.write('')
        st.subheader('Week 8 Estimated Pick Percentages')
        st.write('')
        az_week_8_pick_% = st.selectbox("Arizona Cardinals Estimated Week 8 Pick %:", options=required_week_options)
        atl_week_8_pick_% = st.selectbox("Atlanta Falcons Estimated Week 8 Pick %:", options=required_week_options)
        bal_week_8_pick_% = st.selectbox("Baltimore Ravens Estimated Week 8 Pick %:", options=required_week_options)
        buf_week_8_pick_% = st.selectbox("Buffalo Bills Estimated Week 8 Pick %:", options=required_week_options)
        car_week_8_pick_% = st.selectbox("Carolina Panthers Estimated Week 8 Pick %:", options=required_week_options)
        chi_week_8_pick_% = st.selectbox("Chicago Bears Estimated Week 8 Pick %:", options=required_week_options)
        cin_week_8_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 8 Pick %:", options=required_week_options)
        cle_week_8_pick_% = st.selectbox("Cleveland Browns Estimated Week 8 Pick %:", options=required_week_options)
        dal_week_8_pick_% = st.selectbox("Dallas Cowboys Estimated Week 8 Pick %:", options=required_week_options)
        den_week_8_pick_% = st.selectbox("Denver Broncos Estimated Week 8 Pick %:", options=required_week_options)
        det_week_8_pick_% = st.selectbox("Detroit Lions Estimated Week 8 Pick %:", options=required_week_options)
        gb_week_8_pick_% = st.selectbox("Green Bay Packers Estimated Week 8 Pick %:", options=required_week_options)
        hou_week_8_pick_% = st.selectbox("Houston Texans Estimated Week 8 Pick %:", options=required_week_options)
        ind_week_8_pick_% = st.selectbox("Indianapoils Colts Estimated Week 8 Pick %:", options=required_week_options)
        jax_week_8_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 8 Pick %:", options=required_week_options)
        kc_week_8_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 8 Pick %:", options=required_week_options)
        lv_week_8_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 8 Pick %:", options=required_week_options)
        lac_week_8_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 8 Pick %:", options=required_week_options)
        lar_week_8_pick_% = st.selectbox("Los Angeles Rams Estimated Week 8 Pick %:", options=required_week_options)
        mia_week_8_pick_% = st.selectbox("Miami Dolphins Estimated Week 8 Pick %:", options=required_week_options)
        min_week_8_pick_% = st.selectbox("Minnesota Vikings Estimated Week 8 Pick %:", options=required_week_options)
        ne_week_8_pick_% = st.selectbox("New England Patriots Estimated Week 8 Pick %:", options=required_week_options)
        no_week_8_pick_% = st.selectbox("New Orleans Saints Estimated Week 8 Pick %:", options=required_week_options)
        nyg_week_8_pick_% = st.selectbox("New York Giants Estimated Week 8 Pick %:", options=required_week_options)
        nyj_week_8_pick_% = st.selectbox("New York Jets Estimated Week 8 Pick %:", options=required_week_options)
        phi_week_8_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 8 Pick %:", options=required_week_options)
        pit_week_8_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 8 Pick %:", options=required_week_options)
        sf_week_8_pick_% = st.selectbox("San Francisco 89ers Estimated Week 8 Pick %:", options=required_week_options)
        sea_week_8_pick_% = st.selectbox("Seattle Seahawks Estimated Week 8 Pick %:", options=required_week_options)
        tb_week_8_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 8 Pick %:", options=required_week_options)
        ten_week_8_pick_% = st.selectbox("Tennessee Titans Estimated Week 8 Pick %:", options=required_week_options)
        was_week_8_pick_% = st.selectbox("Washington Commanders Estimated Week 8 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_9_pick percents = st.checkbox('Add Week 9 Pick Percentages?')
    if week_9_pick_percents:
        st.write('')
        st.subheader('Week 9 Estimated Pick Percentages')
        st.write('')
        az_week_9_pick_% = st.selectbox("Arizona Cardinals Estimated Week 9 Pick %:", options=required_week_options)
        atl_week_9_pick_% = st.selectbox("Atlanta Falcons Estimated Week 9 Pick %:", options=required_week_options)
        bal_week_9_pick_% = st.selectbox("Baltimore Ravens Estimated Week 9 Pick %:", options=required_week_options)
        buf_week_9_pick_% = st.selectbox("Buffalo Bills Estimated Week 9 Pick %:", options=required_week_options)
        car_week_9_pick_% = st.selectbox("Carolina Panthers Estimated Week 9 Pick %:", options=required_week_options)
        chi_week_9_pick_% = st.selectbox("Chicago Bears Estimated Week 9 Pick %:", options=required_week_options)
        cin_week_9_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 9 Pick %:", options=required_week_options)
        cle_week_9_pick_% = st.selectbox("Cleveland Browns Estimated Week 9 Pick %:", options=required_week_options)
        dal_week_9_pick_% = st.selectbox("Dallas Cowboys Estimated Week 9 Pick %:", options=required_week_options)
        den_week_9_pick_% = st.selectbox("Denver Broncos Estimated Week 9 Pick %:", options=required_week_options)
        det_week_9_pick_% = st.selectbox("Detroit Lions Estimated Week 9 Pick %:", options=required_week_options)
        gb_week_9_pick_% = st.selectbox("Green Bay Packers Estimated Week 9 Pick %:", options=required_week_options)
        hou_week_9_pick_% = st.selectbox("Houston Texans Estimated Week 9 Pick %:", options=required_week_options)
        ind_week_9_pick_% = st.selectbox("Indianapoils Colts Estimated Week 9 Pick %:", options=required_week_options)
        jax_week_9_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 9 Pick %:", options=required_week_options)
        kc_week_9_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 9 Pick %:", options=required_week_options)
        lv_week_9_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 9 Pick %:", options=required_week_options)
        lac_week_9_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 9 Pick %:", options=required_week_options)
        lar_week_9_pick_% = st.selectbox("Los Angeles Rams Estimated Week 9 Pick %:", options=required_week_options)
        mia_week_9_pick_% = st.selectbox("Miami Dolphins Estimated Week 9 Pick %:", options=required_week_options)
        min_week_9_pick_% = st.selectbox("Minnesota Vikings Estimated Week 9 Pick %:", options=required_week_options)
        ne_week_9_pick_% = st.selectbox("New England Patriots Estimated Week 9 Pick %:", options=required_week_options)
        no_week_9_pick_% = st.selectbox("New Orleans Saints Estimated Week 9 Pick %:", options=required_week_options)
        nyg_week_9_pick_% = st.selectbox("New York Giants Estimated Week 9 Pick %:", options=required_week_options)
        nyj_week_9_pick_% = st.selectbox("New York Jets Estimated Week 9 Pick %:", options=required_week_options)
        phi_week_9_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 9 Pick %:", options=required_week_options)
        pit_week_9_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 9 Pick %:", options=required_week_options)
        sf_week_9_pick_% = st.selectbox("San Francisco 99ers Estimated Week 9 Pick %:", options=required_week_options)
        sea_week_9_pick_% = st.selectbox("Seattle Seahawks Estimated Week 9 Pick %:", options=required_week_options)
        tb_week_9_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 9 Pick %:", options=required_week_options)
        ten_week_9_pick_% = st.selectbox("Tennessee Titans Estimated Week 9 Pick %:", options=required_week_options)
        was_week_9_pick_% = st.selectbox("Washington Commanders Estimated Week 9 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_10_pick percents = st.checkbox('Add Week 10 Pick Percentages?')
    if week_10_pick_percents:
        st.write('')
        st.subheader('Week 10 Estimated Pick Percentages')
        st.write('')
        az_week_10_pick_% = st.selectbox("Arizona Cardinals Estimated Week 10 Pick %:", options=required_week_options)
        atl_week_10_pick_% = st.selectbox("Atlanta Falcons Estimated Week 10 Pick %:", options=required_week_options)
        bal_week_10_pick_% = st.selectbox("Baltimore Ravens Estimated Week 10 Pick %:", options=required_week_options)
        buf_week_10_pick_% = st.selectbox("Buffalo Bills Estimated Week 10 Pick %:", options=required_week_options)
        car_week_10_pick_% = st.selectbox("Carolina Panthers Estimated Week 10 Pick %:", options=required_week_options)
        chi_week_10_pick_% = st.selectbox("Chicago Bears Estimated Week 10 Pick %:", options=required_week_options)
        cin_week_10_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 10 Pick %:", options=required_week_options)
        cle_week_10_pick_% = st.selectbox("Cleveland Browns Estimated Week 10 Pick %:", options=required_week_options)
        dal_week_10_pick_% = st.selectbox("Dallas Cowboys Estimated Week 10 Pick %:", options=required_week_options)
        den_week_10_pick_% = st.selectbox("Denver Broncos Estimated Week 10 Pick %:", options=required_week_options)
        det_week_10_pick_% = st.selectbox("Detroit Lions Estimated Week 10 Pick %:", options=required_week_options)
        gb_week_10_pick_% = st.selectbox("Green Bay Packers Estimated Week 10 Pick %:", options=required_week_options)
        hou_week_10_pick_% = st.selectbox("Houston Texans Estimated Week 10 Pick %:", options=required_week_options)
        ind_week_10_pick_% = st.selectbox("Indianapoils Colts Estimated Week 10 Pick %:", options=required_week_options)
        jax_week_10_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 10 Pick %:", options=required_week_options)
        kc_week_10_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 10 Pick %:", options=required_week_options)
        lv_week_10_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 10 Pick %:", options=required_week_options)
        lac_week_10_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 10 Pick %:", options=required_week_options)
        lar_week_10_pick_% = st.selectbox("Los Angeles Rams Estimated Week 10 Pick %:", options=required_week_options)
        mia_week_10_pick_% = st.selectbox("Miami Dolphins Estimated Week 10 Pick %:", options=required_week_options)
        min_week_10_pick_% = st.selectbox("Minnesota Vikings Estimated Week 10 Pick %:", options=required_week_options)
        ne_week_10_pick_% = st.selectbox("New England Patriots Estimated Week 10 Pick %:", options=required_week_options)
        no_week_10_pick_% = st.selectbox("New Orleans Saints Estimated Week 10 Pick %:", options=required_week_options)
        nyg_week_10_pick_% = st.selectbox("New York Giants Estimated Week 10 Pick %:", options=required_week_options)
        nyj_week_10_pick_% = st.selectbox("New York Jets Estimated Week 10 Pick %:", options=required_week_options)
        phi_week_10_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 10 Pick %:", options=required_week_options)
        pit_week_10_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 10 Pick %:", options=required_week_options)
        sf_week_10_pick_% = st.selectbox("San Francisco 1010ers Estimated Week 10 Pick %:", options=required_week_options)
        sea_week_10_pick_% = st.selectbox("Seattle Seahawks Estimated Week 10 Pick %:", options=required_week_options)
        tb_week_10_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 10 Pick %:", options=required_week_options)
        ten_week_10_pick_% = st.selectbox("Tennessee Titans Estimated Week 10 Pick %:", options=required_week_options)
        was_week_10_pick_% = st.selectbox("Washington Commanders Estimated Week 10 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_11_pick percents = st.checkbox('Add Week 11 Pick Percentages?')
    if week_11_pick_percents:
        st.write('')
        st.subheader('Week 11 Estimated Pick Percentages')
        st.write('')
        az_week_11_pick_% = st.selectbox("Arizona Cardinals Estimated Week 11 Pick %:", options=required_week_options)
        atl_week_11_pick_% = st.selectbox("Atlanta Falcons Estimated Week 11 Pick %:", options=required_week_options)
        bal_week_11_pick_% = st.selectbox("Baltimore Ravens Estimated Week 11 Pick %:", options=required_week_options)
        buf_week_11_pick_% = st.selectbox("Buffalo Bills Estimated Week 11 Pick %:", options=required_week_options)
        car_week_11_pick_% = st.selectbox("Carolina Panthers Estimated Week 11 Pick %:", options=required_week_options)
        chi_week_11_pick_% = st.selectbox("Chicago Bears Estimated Week 11 Pick %:", options=required_week_options)
        cin_week_11_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 11 Pick %:", options=required_week_options)
        cle_week_11_pick_% = st.selectbox("Cleveland Browns Estimated Week 11 Pick %:", options=required_week_options)
        dal_week_11_pick_% = st.selectbox("Dallas Cowboys Estimated Week 11 Pick %:", options=required_week_options)
        den_week_11_pick_% = st.selectbox("Denver Broncos Estimated Week 11 Pick %:", options=required_week_options)
        det_week_11_pick_% = st.selectbox("Detroit Lions Estimated Week 11 Pick %:", options=required_week_options)
        gb_week_11_pick_% = st.selectbox("Green Bay Packers Estimated Week 11 Pick %:", options=required_week_options)
        hou_week_11_pick_% = st.selectbox("Houston Texans Estimated Week 11 Pick %:", options=required_week_options)
        ind_week_11_pick_% = st.selectbox("Indianapoils Colts Estimated Week 11 Pick %:", options=required_week_options)
        jax_week_11_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 11 Pick %:", options=required_week_options)
        kc_week_11_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 11 Pick %:", options=required_week_options)
        lv_week_11_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 11 Pick %:", options=required_week_options)
        lac_week_11_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 11 Pick %:", options=required_week_options)
        lar_week_11_pick_% = st.selectbox("Los Angeles Rams Estimated Week 11 Pick %:", options=required_week_options)
        mia_week_11_pick_% = st.selectbox("Miami Dolphins Estimated Week 11 Pick %:", options=required_week_options)
        min_week_11_pick_% = st.selectbox("Minnesota Vikings Estimated Week 11 Pick %:", options=required_week_options)
        ne_week_11_pick_% = st.selectbox("New England Patriots Estimated Week 11 Pick %:", options=required_week_options)
        no_week_11_pick_% = st.selectbox("New Orleans Saints Estimated Week 11 Pick %:", options=required_week_options)
        nyg_week_11_pick_% = st.selectbox("New York Giants Estimated Week 11 Pick %:", options=required_week_options)
        nyj_week_11_pick_% = st.selectbox("New York Jets Estimated Week 11 Pick %:", options=required_week_options)
        phi_week_11_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 11 Pick %:", options=required_week_options)
        pit_week_11_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 11 Pick %:", options=required_week_options)
        sf_week_11_pick_% = st.selectbox("San Francisco 1111ers Estimated Week 11 Pick %:", options=required_week_options)
        sea_week_11_pick_% = st.selectbox("Seattle Seahawks Estimated Week 11 Pick %:", options=required_week_options)
        tb_week_11_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 11 Pick %:", options=required_week_options)
        ten_week_11_pick_% = st.selectbox("Tennessee Titans Estimated Week 11 Pick %:", options=required_week_options)
        was_week_11_pick_% = st.selectbox("Washington Commanders Estimated Week 11 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_12_pick percents = st.checkbox('Add Week 12 Pick Percentages?')
    if week_12_pick_percents:
        st.write('')
        st.subheader('Week 12 Estimated Pick Percentages')
        st.write('')
        az_week_12_pick_% = st.selectbox("Arizona Cardinals Estimated Week 12 Pick %:", options=required_week_options)
        atl_week_12_pick_% = st.selectbox("Atlanta Falcons Estimated Week 12 Pick %:", options=required_week_options)
        bal_week_12_pick_% = st.selectbox("Baltimore Ravens Estimated Week 12 Pick %:", options=required_week_options)
        buf_week_12_pick_% = st.selectbox("Buffalo Bills Estimated Week 12 Pick %:", options=required_week_options)
        car_week_12_pick_% = st.selectbox("Carolina Panthers Estimated Week 12 Pick %:", options=required_week_options)
        chi_week_12_pick_% = st.selectbox("Chicago Bears Estimated Week 12 Pick %:", options=required_week_options)
        cin_week_12_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 12 Pick %:", options=required_week_options)
        cle_week_12_pick_% = st.selectbox("Cleveland Browns Estimated Week 12 Pick %:", options=required_week_options)
        dal_week_12_pick_% = st.selectbox("Dallas Cowboys Estimated Week 12 Pick %:", options=required_week_options)
        den_week_12_pick_% = st.selectbox("Denver Broncos Estimated Week 12 Pick %:", options=required_week_options)
        det_week_12_pick_% = st.selectbox("Detroit Lions Estimated Week 12 Pick %:", options=required_week_options)
        gb_week_12_pick_% = st.selectbox("Green Bay Packers Estimated Week 12 Pick %:", options=required_week_options)
        hou_week_12_pick_% = st.selectbox("Houston Texans Estimated Week 12 Pick %:", options=required_week_options)
        ind_week_12_pick_% = st.selectbox("Indianapoils Colts Estimated Week 12 Pick %:", options=required_week_options)
        jax_week_12_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 12 Pick %:", options=required_week_options)
        kc_week_12_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 12 Pick %:", options=required_week_options)
        lv_week_12_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 12 Pick %:", options=required_week_options)
        lac_week_12_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 12 Pick %:", options=required_week_options)
        lar_week_12_pick_% = st.selectbox("Los Angeles Rams Estimated Week 12 Pick %:", options=required_week_options)
        mia_week_12_pick_% = st.selectbox("Miami Dolphins Estimated Week 12 Pick %:", options=required_week_options)
        min_week_12_pick_% = st.selectbox("Minnesota Vikings Estimated Week 12 Pick %:", options=required_week_options)
        ne_week_12_pick_% = st.selectbox("New England Patriots Estimated Week 12 Pick %:", options=required_week_options)
        no_week_12_pick_% = st.selectbox("New Orleans Saints Estimated Week 12 Pick %:", options=required_week_options)
        nyg_week_12_pick_% = st.selectbox("New York Giants Estimated Week 12 Pick %:", options=required_week_options)
        nyj_week_12_pick_% = st.selectbox("New York Jets Estimated Week 12 Pick %:", options=required_week_options)
        phi_week_12_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 12 Pick %:", options=required_week_options)
        pit_week_12_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 12 Pick %:", options=required_week_options)
        sf_week_12_pick_% = st.selectbox("San Francisco 1212ers Estimated Week 12 Pick %:", options=required_week_options)
        sea_week_12_pick_% = st.selectbox("Seattle Seahawks Estimated Week 12 Pick %:", options=required_week_options)
        tb_week_12_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 12 Pick %:", options=required_week_options)
        ten_week_12_pick_% = st.selectbox("Tennessee Titans Estimated Week 12 Pick %:", options=required_week_options)
        was_week_12_pick_% = st.selectbox("Washington Commanders Estimated Week 12 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_13_pick percents = st.checkbox('Add Week 13 Pick Percentages?')
    if week_13_pick_percents:
        st.write('')
        st.subheader('Week 13 Estimated Pick Percentages')
        st.write('')
        az_week_13_pick_% = st.selectbox("Arizona Cardinals Estimated Week 13 Pick %:", options=required_week_options)
        atl_week_13_pick_% = st.selectbox("Atlanta Falcons Estimated Week 13 Pick %:", options=required_week_options)
        bal_week_13_pick_% = st.selectbox("Baltimore Ravens Estimated Week 13 Pick %:", options=required_week_options)
        buf_week_13_pick_% = st.selectbox("Buffalo Bills Estimated Week 13 Pick %:", options=required_week_options)
        car_week_13_pick_% = st.selectbox("Carolina Panthers Estimated Week 13 Pick %:", options=required_week_options)
        chi_week_13_pick_% = st.selectbox("Chicago Bears Estimated Week 13 Pick %:", options=required_week_options)
        cin_week_13_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 13 Pick %:", options=required_week_options)
        cle_week_13_pick_% = st.selectbox("Cleveland Browns Estimated Week 13 Pick %:", options=required_week_options)
        dal_week_13_pick_% = st.selectbox("Dallas Cowboys Estimated Week 13 Pick %:", options=required_week_options)
        den_week_13_pick_% = st.selectbox("Denver Broncos Estimated Week 13 Pick %:", options=required_week_options)
        det_week_13_pick_% = st.selectbox("Detroit Lions Estimated Week 13 Pick %:", options=required_week_options)
        gb_week_13_pick_% = st.selectbox("Green Bay Packers Estimated Week 13 Pick %:", options=required_week_options)
        hou_week_13_pick_% = st.selectbox("Houston Texans Estimated Week 13 Pick %:", options=required_week_options)
        ind_week_13_pick_% = st.selectbox("Indianapoils Colts Estimated Week 13 Pick %:", options=required_week_options)
        jax_week_13_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 13 Pick %:", options=required_week_options)
        kc_week_13_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 13 Pick %:", options=required_week_options)
        lv_week_13_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 13 Pick %:", options=required_week_options)
        lac_week_13_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 13 Pick %:", options=required_week_options)
        lar_week_13_pick_% = st.selectbox("Los Angeles Rams Estimated Week 13 Pick %:", options=required_week_options)
        mia_week_13_pick_% = st.selectbox("Miami Dolphins Estimated Week 13 Pick %:", options=required_week_options)
        min_week_13_pick_% = st.selectbox("Minnesota Vikings Estimated Week 13 Pick %:", options=required_week_options)
        ne_week_13_pick_% = st.selectbox("New England Patriots Estimated Week 13 Pick %:", options=required_week_options)
        no_week_13_pick_% = st.selectbox("New Orleans Saints Estimated Week 13 Pick %:", options=required_week_options)
        nyg_week_13_pick_% = st.selectbox("New York Giants Estimated Week 13 Pick %:", options=required_week_options)
        nyj_week_13_pick_% = st.selectbox("New York Jets Estimated Week 13 Pick %:", options=required_week_options)
        phi_week_13_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 13 Pick %:", options=required_week_options)
        pit_week_13_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 13 Pick %:", options=required_week_options)
        sf_week_13_pick_% = st.selectbox("San Francisco 1313ers Estimated Week 13 Pick %:", options=required_week_options)
        sea_week_13_pick_% = st.selectbox("Seattle Seahawks Estimated Week 13 Pick %:", options=required_week_options)
        tb_week_13_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 13 Pick %:", options=required_week_options)
        ten_week_13_pick_% = st.selectbox("Tennessee Titans Estimated Week 13 Pick %:", options=required_week_options)
        was_week_13_pick_% = st.selectbox("Washington Commanders Estimated Week 13 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_14_pick percents = st.checkbox('Add Week 14 Pick Percentages?')
    if week_14_pick_percents:
        st.write('')
        st.subheader('Week 14 Estimated Pick Percentages')
        st.write('')
        az_week_14_pick_% = st.selectbox("Arizona Cardinals Estimated Week 14 Pick %:", options=required_week_options)
        atl_week_14_pick_% = st.selectbox("Atlanta Falcons Estimated Week 14 Pick %:", options=required_week_options)
        bal_week_14_pick_% = st.selectbox("Baltimore Ravens Estimated Week 14 Pick %:", options=required_week_options)
        buf_week_14_pick_% = st.selectbox("Buffalo Bills Estimated Week 14 Pick %:", options=required_week_options)
        car_week_14_pick_% = st.selectbox("Carolina Panthers Estimated Week 14 Pick %:", options=required_week_options)
        chi_week_14_pick_% = st.selectbox("Chicago Bears Estimated Week 14 Pick %:", options=required_week_options)
        cin_week_14_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 14 Pick %:", options=required_week_options)
        cle_week_14_pick_% = st.selectbox("Cleveland Browns Estimated Week 14 Pick %:", options=required_week_options)
        dal_week_14_pick_% = st.selectbox("Dallas Cowboys Estimated Week 14 Pick %:", options=required_week_options)
        den_week_14_pick_% = st.selectbox("Denver Broncos Estimated Week 14 Pick %:", options=required_week_options)
        det_week_14_pick_% = st.selectbox("Detroit Lions Estimated Week 14 Pick %:", options=required_week_options)
        gb_week_14_pick_% = st.selectbox("Green Bay Packers Estimated Week 14 Pick %:", options=required_week_options)
        hou_week_14_pick_% = st.selectbox("Houston Texans Estimated Week 14 Pick %:", options=required_week_options)
        ind_week_14_pick_% = st.selectbox("Indianapoils Colts Estimated Week 14 Pick %:", options=required_week_options)
        jax_week_14_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 14 Pick %:", options=required_week_options)
        kc_week_14_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 14 Pick %:", options=required_week_options)
        lv_week_14_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 14 Pick %:", options=required_week_options)
        lac_week_14_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 14 Pick %:", options=required_week_options)
        lar_week_14_pick_% = st.selectbox("Los Angeles Rams Estimated Week 14 Pick %:", options=required_week_options)
        mia_week_14_pick_% = st.selectbox("Miami Dolphins Estimated Week 14 Pick %:", options=required_week_options)
        min_week_14_pick_% = st.selectbox("Minnesota Vikings Estimated Week 14 Pick %:", options=required_week_options)
        ne_week_14_pick_% = st.selectbox("New England Patriots Estimated Week 14 Pick %:", options=required_week_options)
        no_week_14_pick_% = st.selectbox("New Orleans Saints Estimated Week 14 Pick %:", options=required_week_options)
        nyg_week_14_pick_% = st.selectbox("New York Giants Estimated Week 14 Pick %:", options=required_week_options)
        nyj_week_14_pick_% = st.selectbox("New York Jets Estimated Week 14 Pick %:", options=required_week_options)
        phi_week_14_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 14 Pick %:", options=required_week_options)
        pit_week_14_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 14 Pick %:", options=required_week_options)
        sf_week_14_pick_% = st.selectbox("San Francisco 1414ers Estimated Week 14 Pick %:", options=required_week_options)
        sea_week_14_pick_% = st.selectbox("Seattle Seahawks Estimated Week 14 Pick %:", options=required_week_options)
        tb_week_14_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 14 Pick %:", options=required_week_options)
        ten_week_14_pick_% = st.selectbox("Tennessee Titans Estimated Week 14 Pick %:", options=required_week_options)
        was_week_14_pick_% = st.selectbox("Washington Commanders Estimated Week 14 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_15_pick percents = st.checkbox('Add Week 15 Pick Percentages?')
    if week_15_pick_percents:
        st.write('')
        st.subheader('Week 15 Estimated Pick Percentages')
        st.write('')
        az_week_15_pick_% = st.selectbox("Arizona Cardinals Estimated Week 15 Pick %:", options=required_week_options)
        atl_week_15_pick_% = st.selectbox("Atlanta Falcons Estimated Week 15 Pick %:", options=required_week_options)
        bal_week_15_pick_% = st.selectbox("Baltimore Ravens Estimated Week 15 Pick %:", options=required_week_options)
        buf_week_15_pick_% = st.selectbox("Buffalo Bills Estimated Week 15 Pick %:", options=required_week_options)
        car_week_15_pick_% = st.selectbox("Carolina Panthers Estimated Week 15 Pick %:", options=required_week_options)
        chi_week_15_pick_% = st.selectbox("Chicago Bears Estimated Week 15 Pick %:", options=required_week_options)
        cin_week_15_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 15 Pick %:", options=required_week_options)
        cle_week_15_pick_% = st.selectbox("Cleveland Browns Estimated Week 15 Pick %:", options=required_week_options)
        dal_week_15_pick_% = st.selectbox("Dallas Cowboys Estimated Week 15 Pick %:", options=required_week_options)
        den_week_15_pick_% = st.selectbox("Denver Broncos Estimated Week 15 Pick %:", options=required_week_options)
        det_week_15_pick_% = st.selectbox("Detroit Lions Estimated Week 15 Pick %:", options=required_week_options)
        gb_week_15_pick_% = st.selectbox("Green Bay Packers Estimated Week 15 Pick %:", options=required_week_options)
        hou_week_15_pick_% = st.selectbox("Houston Texans Estimated Week 15 Pick %:", options=required_week_options)
        ind_week_15_pick_% = st.selectbox("Indianapoils Colts Estimated Week 15 Pick %:", options=required_week_options)
        jax_week_15_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 15 Pick %:", options=required_week_options)
        kc_week_15_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 15 Pick %:", options=required_week_options)
        lv_week_15_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 15 Pick %:", options=required_week_options)
        lac_week_15_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 15 Pick %:", options=required_week_options)
        lar_week_15_pick_% = st.selectbox("Los Angeles Rams Estimated Week 15 Pick %:", options=required_week_options)
        mia_week_15_pick_% = st.selectbox("Miami Dolphins Estimated Week 15 Pick %:", options=required_week_options)
        min_week_15_pick_% = st.selectbox("Minnesota Vikings Estimated Week 15 Pick %:", options=required_week_options)
        ne_week_15_pick_% = st.selectbox("New England Patriots Estimated Week 15 Pick %:", options=required_week_options)
        no_week_15_pick_% = st.selectbox("New Orleans Saints Estimated Week 15 Pick %:", options=required_week_options)
        nyg_week_15_pick_% = st.selectbox("New York Giants Estimated Week 15 Pick %:", options=required_week_options)
        nyj_week_15_pick_% = st.selectbox("New York Jets Estimated Week 15 Pick %:", options=required_week_options)
        phi_week_15_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 15 Pick %:", options=required_week_options)
        pit_week_15_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 15 Pick %:", options=required_week_options)
        sf_week_15_pick_% = st.selectbox("San Francisco 1515ers Estimated Week 15 Pick %:", options=required_week_options)
        sea_week_15_pick_% = st.selectbox("Seattle Seahawks Estimated Week 15 Pick %:", options=required_week_options)
        tb_week_15_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 15 Pick %:", options=required_week_options)
        ten_week_15_pick_% = st.selectbox("Tennessee Titans Estimated Week 15 Pick %:", options=required_week_options)
        was_week_15_pick_% = st.selectbox("Washington Commanders Estimated Week 15 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_16_pick percents = st.checkbox('Add Week 16 Pick Percentages?')
    if week_16_pick_percents:
        st.write('')
        st.subheader('Week 16 Estimated Pick Percentages')
        st.write('')
        az_week_16_pick_% = st.selectbox("Arizona Cardinals Estimated Week 16 Pick %:", options=required_week_options)
        atl_week_16_pick_% = st.selectbox("Atlanta Falcons Estimated Week 16 Pick %:", options=required_week_options)
        bal_week_16_pick_% = st.selectbox("Baltimore Ravens Estimated Week 16 Pick %:", options=required_week_options)
        buf_week_16_pick_% = st.selectbox("Buffalo Bills Estimated Week 16 Pick %:", options=required_week_options)
        car_week_16_pick_% = st.selectbox("Carolina Panthers Estimated Week 16 Pick %:", options=required_week_options)
        chi_week_16_pick_% = st.selectbox("Chicago Bears Estimated Week 16 Pick %:", options=required_week_options)
        cin_week_16_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 16 Pick %:", options=required_week_options)
        cle_week_16_pick_% = st.selectbox("Cleveland Browns Estimated Week 16 Pick %:", options=required_week_options)
        dal_week_16_pick_% = st.selectbox("Dallas Cowboys Estimated Week 16 Pick %:", options=required_week_options)
        den_week_16_pick_% = st.selectbox("Denver Broncos Estimated Week 16 Pick %:", options=required_week_options)
        det_week_16_pick_% = st.selectbox("Detroit Lions Estimated Week 16 Pick %:", options=required_week_options)
        gb_week_16_pick_% = st.selectbox("Green Bay Packers Estimated Week 16 Pick %:", options=required_week_options)
        hou_week_16_pick_% = st.selectbox("Houston Texans Estimated Week 16 Pick %:", options=required_week_options)
        ind_week_16_pick_% = st.selectbox("Indianapoils Colts Estimated Week 16 Pick %:", options=required_week_options)
        jax_week_16_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 16 Pick %:", options=required_week_options)
        kc_week_16_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 16 Pick %:", options=required_week_options)
        lv_week_16_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 16 Pick %:", options=required_week_options)
        lac_week_16_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 16 Pick %:", options=required_week_options)
        lar_week_16_pick_% = st.selectbox("Los Angeles Rams Estimated Week 16 Pick %:", options=required_week_options)
        mia_week_16_pick_% = st.selectbox("Miami Dolphins Estimated Week 16 Pick %:", options=required_week_options)
        min_week_16_pick_% = st.selectbox("Minnesota Vikings Estimated Week 16 Pick %:", options=required_week_options)
        ne_week_16_pick_% = st.selectbox("New England Patriots Estimated Week 16 Pick %:", options=required_week_options)
        no_week_16_pick_% = st.selectbox("New Orleans Saints Estimated Week 16 Pick %:", options=required_week_options)
        nyg_week_16_pick_% = st.selectbox("New York Giants Estimated Week 16 Pick %:", options=required_week_options)
        nyj_week_16_pick_% = st.selectbox("New York Jets Estimated Week 16 Pick %:", options=required_week_options)
        phi_week_16_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 16 Pick %:", options=required_week_options)
        pit_week_16_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 16 Pick %:", options=required_week_options)
        sf_week_16_pick_% = st.selectbox("San Francisco 1616ers Estimated Week 16 Pick %:", options=required_week_options)
        sea_week_16_pick_% = st.selectbox("Seattle Seahawks Estimated Week 16 Pick %:", options=required_week_options)
        tb_week_16_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 16 Pick %:", options=required_week_options)
        ten_week_16_pick_% = st.selectbox("Tennessee Titans Estimated Week 16 Pick %:", options=required_week_options)
        was_week_16_pick_% = st.selectbox("Washington Commanders Estimated Week 16 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_17_pick percents = st.checkbox('Add Week 17 Pick Percentages?')
    if week_17_pick_percents:
        st.write('')
        st.subheader('Week 17 Estimated Pick Percentages')
        st.write('')
        az_week_17_pick_% = st.selectbox("Arizona Cardinals Estimated Week 17 Pick %:", options=required_week_options)
        atl_week_17_pick_% = st.selectbox("Atlanta Falcons Estimated Week 17 Pick %:", options=required_week_options)
        bal_week_17_pick_% = st.selectbox("Baltimore Ravens Estimated Week 17 Pick %:", options=required_week_options)
        buf_week_17_pick_% = st.selectbox("Buffalo Bills Estimated Week 17 Pick %:", options=required_week_options)
        car_week_17_pick_% = st.selectbox("Carolina Panthers Estimated Week 17 Pick %:", options=required_week_options)
        chi_week_17_pick_% = st.selectbox("Chicago Bears Estimated Week 17 Pick %:", options=required_week_options)
        cin_week_17_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 17 Pick %:", options=required_week_options)
        cle_week_17_pick_% = st.selectbox("Cleveland Browns Estimated Week 17 Pick %:", options=required_week_options)
        dal_week_17_pick_% = st.selectbox("Dallas Cowboys Estimated Week 17 Pick %:", options=required_week_options)
        den_week_17_pick_% = st.selectbox("Denver Broncos Estimated Week 17 Pick %:", options=required_week_options)
        det_week_17_pick_% = st.selectbox("Detroit Lions Estimated Week 17 Pick %:", options=required_week_options)
        gb_week_17_pick_% = st.selectbox("Green Bay Packers Estimated Week 17 Pick %:", options=required_week_options)
        hou_week_17_pick_% = st.selectbox("Houston Texans Estimated Week 17 Pick %:", options=required_week_options)
        ind_week_17_pick_% = st.selectbox("Indianapoils Colts Estimated Week 17 Pick %:", options=required_week_options)
        jax_week_17_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 17 Pick %:", options=required_week_options)
        kc_week_17_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 17 Pick %:", options=required_week_options)
        lv_week_17_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 17 Pick %:", options=required_week_options)
        lac_week_17_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 17 Pick %:", options=required_week_options)
        lar_week_17_pick_% = st.selectbox("Los Angeles Rams Estimated Week 17 Pick %:", options=required_week_options)
        mia_week_17_pick_% = st.selectbox("Miami Dolphins Estimated Week 17 Pick %:", options=required_week_options)
        min_week_17_pick_% = st.selectbox("Minnesota Vikings Estimated Week 17 Pick %:", options=required_week_options)
        ne_week_17_pick_% = st.selectbox("New England Patriots Estimated Week 17 Pick %:", options=required_week_options)
        no_week_17_pick_% = st.selectbox("New Orleans Saints Estimated Week 17 Pick %:", options=required_week_options)
        nyg_week_17_pick_% = st.selectbox("New York Giants Estimated Week 17 Pick %:", options=required_week_options)
        nyj_week_17_pick_% = st.selectbox("New York Jets Estimated Week 17 Pick %:", options=required_week_options)
        phi_week_17_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 17 Pick %:", options=required_week_options)
        pit_week_17_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 17 Pick %:", options=required_week_options)
        sf_week_17_pick_% = st.selectbox("San Francisco 1717ers Estimated Week 17 Pick %:", options=required_week_options)
        sea_week_17_pick_% = st.selectbox("Seattle Seahawks Estimated Week 17 Pick %:", options=required_week_options)
        tb_week_17_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 17 Pick %:", options=required_week_options)
        ten_week_17_pick_% = st.selectbox("Tennessee Titans Estimated Week 17 Pick %:", options=required_week_options)
        was_week_17_pick_% = st.selectbox("Washington Commanders Estimated Week 17 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    week_18_pick percents = st.checkbox('Add Week 18 Pick Percentages?')
    if week_18_pick_percents:
        st.write('')
        st.subheader('Week 18 Estimated Pick Percentages')
        st.write('')
        az_week_18_pick_% = st.selectbox("Arizona Cardinals Estimated Week 18 Pick %:", options=required_week_options)
        atl_week_18_pick_% = st.selectbox("Atlanta Falcons Estimated Week 18 Pick %:", options=required_week_options)
        bal_week_18_pick_% = st.selectbox("Baltimore Ravens Estimated Week 18 Pick %:", options=required_week_options)
        buf_week_18_pick_% = st.selectbox("Buffalo Bills Estimated Week 18 Pick %:", options=required_week_options)
        car_week_18_pick_% = st.selectbox("Carolina Panthers Estimated Week 18 Pick %:", options=required_week_options)
        chi_week_18_pick_% = st.selectbox("Chicago Bears Estimated Week 18 Pick %:", options=required_week_options)
        cin_week_18_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 18 Pick %:", options=required_week_options)
        cle_week_18_pick_% = st.selectbox("Cleveland Browns Estimated Week 18 Pick %:", options=required_week_options)
        dal_week_18_pick_% = st.selectbox("Dallas Cowboys Estimated Week 18 Pick %:", options=required_week_options)
        den_week_18_pick_% = st.selectbox("Denver Broncos Estimated Week 18 Pick %:", options=required_week_options)
        det_week_18_pick_% = st.selectbox("Detroit Lions Estimated Week 18 Pick %:", options=required_week_options)
        gb_week_18_pick_% = st.selectbox("Green Bay Packers Estimated Week 18 Pick %:", options=required_week_options)
        hou_week_18_pick_% = st.selectbox("Houston Texans Estimated Week 18 Pick %:", options=required_week_options)
        ind_week_18_pick_% = st.selectbox("Indianapoils Colts Estimated Week 18 Pick %:", options=required_week_options)
        jax_week_18_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 18 Pick %:", options=required_week_options)
        kc_week_18_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 18 Pick %:", options=required_week_options)
        lv_week_18_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 18 Pick %:", options=required_week_options)
        lac_week_18_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 18 Pick %:", options=required_week_options)
        lar_week_18_pick_% = st.selectbox("Los Angeles Rams Estimated Week 18 Pick %:", options=required_week_options)
        mia_week_18_pick_% = st.selectbox("Miami Dolphins Estimated Week 18 Pick %:", options=required_week_options)
        min_week_18_pick_% = st.selectbox("Minnesota Vikings Estimated Week 18 Pick %:", options=required_week_options)
        ne_week_18_pick_% = st.selectbox("New England Patriots Estimated Week 18 Pick %:", options=required_week_options)
        no_week_18_pick_% = st.selectbox("New Orleans Saints Estimated Week 18 Pick %:", options=required_week_options)
        nyg_week_18_pick_% = st.selectbox("New York Giants Estimated Week 18 Pick %:", options=required_week_options)
        nyj_week_18_pick_% = st.selectbox("New York Jets Estimated Week 18 Pick %:", options=required_week_options)
        phi_week_18_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 18 Pick %:", options=required_week_options)
        pit_week_18_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 18 Pick %:", options=required_week_options)
        sf_week_18_pick_% = st.selectbox("San Francisco 1818ers Estimated Week 18 Pick %:", options=required_week_options)
        sea_week_18_pick_% = st.selectbox("Seattle Seahawks Estimated Week 18 Pick %:", options=required_week_options)
        tb_week_18_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 18 Pick %:", options=required_week_options)
        ten_week_18_pick_% = st.selectbox("Tennessee Titans Estimated Week 18 Pick %:", options=required_week_options)
        was_week_18_pick_% = st.selectbox("Washington Commanders Estimated Week 18 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    if selected_contest == 'Circa':
        week_19_pick percents = st.checkbox('Add Week 19 Pick Percentages?')
    if week_19_pick_percents:
        st.write('')
        st.subheader('Week 19 Estimated Pick Percentages')
        st.write('')
        az_week_19_pick_% = st.selectbox("Arizona Cardinals Estimated Week 19 Pick %:", options=required_week_options)
        atl_week_19_pick_% = st.selectbox("Atlanta Falcons Estimated Week 19 Pick %:", options=required_week_options)
        bal_week_19_pick_% = st.selectbox("Baltimore Ravens Estimated Week 19 Pick %:", options=required_week_options)
        buf_week_19_pick_% = st.selectbox("Buffalo Bills Estimated Week 19 Pick %:", options=required_week_options)
        car_week_19_pick_% = st.selectbox("Carolina Panthers Estimated Week 19 Pick %:", options=required_week_options)
        chi_week_19_pick_% = st.selectbox("Chicago Bears Estimated Week 19 Pick %:", options=required_week_options)
        cin_week_19_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 19 Pick %:", options=required_week_options)
        cle_week_19_pick_% = st.selectbox("Cleveland Browns Estimated Week 19 Pick %:", options=required_week_options)
        dal_week_19_pick_% = st.selectbox("Dallas Cowboys Estimated Week 19 Pick %:", options=required_week_options)
        den_week_19_pick_% = st.selectbox("Denver Broncos Estimated Week 19 Pick %:", options=required_week_options)
        det_week_19_pick_% = st.selectbox("Detroit Lions Estimated Week 19 Pick %:", options=required_week_options)
        gb_week_19_pick_% = st.selectbox("Green Bay Packers Estimated Week 19 Pick %:", options=required_week_options)
        hou_week_19_pick_% = st.selectbox("Houston Texans Estimated Week 19 Pick %:", options=required_week_options)
        ind_week_19_pick_% = st.selectbox("Indianapoils Colts Estimated Week 19 Pick %:", options=required_week_options)
        jax_week_19_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 19 Pick %:", options=required_week_options)
        kc_week_19_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 19 Pick %:", options=required_week_options)
        lv_week_19_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 19 Pick %:", options=required_week_options)
        lac_week_19_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 19 Pick %:", options=required_week_options)
        lar_week_19_pick_% = st.selectbox("Los Angeles Rams Estimated Week 19 Pick %:", options=required_week_options)
        mia_week_19_pick_% = st.selectbox("Miami Dolphins Estimated Week 19 Pick %:", options=required_week_options)
        min_week_19_pick_% = st.selectbox("Minnesota Vikings Estimated Week 19 Pick %:", options=required_week_options)
        ne_week_19_pick_% = st.selectbox("New England Patriots Estimated Week 19 Pick %:", options=required_week_options)
        no_week_19_pick_% = st.selectbox("New Orleans Saints Estimated Week 19 Pick %:", options=required_week_options)
        nyg_week_19_pick_% = st.selectbox("New York Giants Estimated Week 19 Pick %:", options=required_week_options)
        nyj_week_19_pick_% = st.selectbox("New York Jets Estimated Week 19 Pick %:", options=required_week_options)
        phi_week_19_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 19 Pick %:", options=required_week_options)
        pit_week_19_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 19 Pick %:", options=required_week_options)
        sf_week_19_pick_% = st.selectbox("San Francisco 1919ers Estimated Week 19 Pick %:", options=required_week_options)
        sea_week_19_pick_% = st.selectbox("Seattle Seahawks Estimated Week 19 Pick %:", options=required_week_options)
        tb_week_19_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 19 Pick %:", options=required_week_options)
        ten_week_19_pick_% = st.selectbox("Tennessee Titans Estimated Week 19 Pick %:", options=required_week_options)
        was_week_19_pick_% = st.selectbox("Washington Commanders Estimated Week 19 Pick %:", options=required_week_options)
    st.write('')
    st.write('')
    if selected_contest == 'Circa':
        week_20_pick percents = st.checkbox('Add Week 20 Pick Percentages?')
    if week_20_pick_percents:
        st.write('')
        st.subheader('Week 20 Estimated Pick Percentages')
        st.write('')
        az_week_20_pick_% = st.selectbox("Arizona Cardinals Estimated Week 20 Pick %:", options=required_week_options)
        atl_week_20_pick_% = st.selectbox("Atlanta Falcons Estimated Week 20 Pick %:", options=required_week_options)
        bal_week_20_pick_% = st.selectbox("Baltimore Ravens Estimated Week 20 Pick %:", options=required_week_options)
        buf_week_20_pick_% = st.selectbox("Buffalo Bills Estimated Week 20 Pick %:", options=required_week_options)
        car_week_20_pick_% = st.selectbox("Carolina Panthers Estimated Week 20 Pick %:", options=required_week_options)
        chi_week_20_pick_% = st.selectbox("Chicago Bears Estimated Week 20 Pick %:", options=required_week_options)
        cin_week_20_pick_% = st.selectbox("Cincinnati Bengals Estimated Week 20 Pick %:", options=required_week_options)
        cle_week_20_pick_% = st.selectbox("Cleveland Browns Estimated Week 20 Pick %:", options=required_week_options)
        dal_week_20_pick_% = st.selectbox("Dallas Cowboys Estimated Week 20 Pick %:", options=required_week_options)
        den_week_20_pick_% = st.selectbox("Denver Broncos Estimated Week 20 Pick %:", options=required_week_options)
        det_week_20_pick_% = st.selectbox("Detroit Lions Estimated Week 20 Pick %:", options=required_week_options)
        gb_week_20_pick_% = st.selectbox("Green Bay Packers Estimated Week 20 Pick %:", options=required_week_options)
        hou_week_20_pick_% = st.selectbox("Houston Texans Estimated Week 20 Pick %:", options=required_week_options)
        ind_week_20_pick_% = st.selectbox("Indianapoils Colts Estimated Week 20 Pick %:", options=required_week_options)
        jax_week_20_pick_% = st.selectbox("Jacksonville Jaguars Estimated Week 20 Pick %:", options=required_week_options)
        kc_week_20_pick_% = st.selectbox("Kansas City Chiefs Estimated Week 20 Pick %:", options=required_week_options)
        lv_week_20_pick_% = st.selectbox("Las Vegas Raiders Estimated Week 20 Pick %:", options=required_week_options)
        lac_week_20_pick_% = st.selectbox("Los Angeles Chargers Estimated Week 20 Pick %:", options=required_week_options)
        lar_week_20_pick_% = st.selectbox("Los Angeles Rams Estimated Week 20 Pick %:", options=required_week_options)
        mia_week_20_pick_% = st.selectbox("Miami Dolphins Estimated Week 20 Pick %:", options=required_week_options)
        min_week_20_pick_% = st.selectbox("Minnesota Vikings Estimated Week 20 Pick %:", options=required_week_options)
        ne_week_20_pick_% = st.selectbox("New England Patriots Estimated Week 20 Pick %:", options=required_week_options)
        no_week_20_pick_% = st.selectbox("New Orleans Saints Estimated Week 20 Pick %:", options=required_week_options)
        nyg_week_20_pick_% = st.selectbox("New York Giants Estimated Week 20 Pick %:", options=required_week_options)
        nyj_week_20_pick_% = st.selectbox("New York Jets Estimated Week 20 Pick %:", options=required_week_options)
        phi_week_20_pick_% = st.selectbox("Philadelphia Eagles Estimated Week 20 Pick %:", options=required_week_options)
        pit_week_20_pick_% = st.selectbox("Pittsburgh Steelers Estimated Week 20 Pick %:", options=required_week_options)
        sf_week_20_pick_% = st.selectbox("San Francisco 2020ers Estimated Week 20 Pick %:", options=required_week_options)
        sea_week_20_pick_% = st.selectbox("Seattle Seahawks Estimated Week 20 Pick %:", options=required_week_options)
        tb_week_20_pick_% = st.selectbox("Tampa Bay Buccaneers Estimated Week 20 Pick %:", options=required_week_options)
        ten_week_20_pick_% = st.selectbox("Tennessee Titans Estimated Week 20 Pick %:", options=required_week_options)
        was_week_20_pick_% = st.selectbox("Washington Commanders Estimated Week 20 Pick %:", options=required_week_options)
